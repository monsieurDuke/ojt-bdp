...
public final class FileOperator
{
  ...
  public final void read(long paramLong1, Buffer paramBuffer, long paramLong2)
  {
    ...
    if (paramLong2 >= 0L)
    {
      ...
      while (paramLong1 > 0L)
      {
        l = this.fileChannel.transferTo(paramLong2, paramLong1, (WritableByteChannel)paramBuffer);
        paramLong2 += l;
        paramLong1 -= l;
      }
      return;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/internal/cache2/FileOperator.class
