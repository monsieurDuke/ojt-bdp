...
public final class Request
{
  ...
  public static class Builder
  {
      ...
      if (i != 0)
      {
        if (paramRequestBody == null)
        {
          if (!(true ^ HttpMethod.requiresRequestBody(paramString))) {
            throw ((Throwable)new IllegalArgumentException(("method " + paramString + " must have a request body.").toString()));
          }
        }
        else {
        ...
        return (Builder)this;
        label113:
        throw ((Throwable)new IllegalArgumentException(("method " + paramString + " must not have a request body.").toString()));
      }
    ...
    public <T> Builder tag(Class<? super T> paramClass, T paramT)
    {
      ...
      if (paramT == null)
      {
        ((Builder)localObject).tags.remove(paramClass);
      }
      else
      {
        if (((Builder)localObject).tags.isEmpty()) {
          ((Builder)localObject).tags = ((Map)new LinkedHashMap());
        }
        localObject = ((Builder)localObject).tags;
        paramT = paramClass.cast(paramT);
        Intrinsics.checkNotNull(paramT);
        ((Map)localObject).put(paramClass, paramT);
      }
      return (Builder)this;
    }
    ...
    public Builder url(String paramString)
    {
      ...
      {
        localStringBuilder = new StringBuilder().append("http:");
      ...
      else if (StringsKt.startsWith(paramString, "wss:", true))
      {
        localStringBuilder = new StringBuilder().append("https:");
        paramString = paramString.substring(4);
        Intrinsics.checkNotNullExpressionValue(paramString, "(this as java.lang.String).substring(startIndex)");
        paramString = paramString;
      }
      return url(HttpUrl.Companion.get(paramString));
    }
    ...
    public Builder url(URL paramURL)
    {
      ...
      Intrinsics.checkNotNullExpressionValue(paramURL, "url.toString()");
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/Request.class
