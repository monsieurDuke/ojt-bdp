...
public final class Address
{
  ...
  {
    boolean bool;
    if (((paramObject instanceof Address)) && (Intrinsics.areEqual(this.url, ((Address)paramObject).url)) && (equalsNonHost$okhttp((Address)paramObject))) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  {
    StringBuilder localStringBuilder2 = new StringBuilder().append("Address{").append(this.url.host()).append(':').append(this.url.port()).append(", ");
    StringBuilder localStringBuilder1;
    Object localObject;
    if (this.proxy != null)
    {
      localStringBuilder1 = new StringBuilder().append("proxy=");
      localObject = this.proxy;
    }
    else
    {
      localStringBuilder1 = new StringBuilder().append("proxySelector=");
      localObject = this.proxySelector;
    }
    return localStringBuilder1.append(localObject).toString() + "}";
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/Address.class
