  ...
  implements SubMenu
{
  ...
  {
    MenuItemImpl localMenuItemImpl = this.mItem;
    int i;
    if (localMenuItemImpl != null) {
      i = localMenuItemImpl.getItemId();
    } else {
      i = 0;
    }
    if (i == 0) {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/view/menu/SubMenuBuilder.class
