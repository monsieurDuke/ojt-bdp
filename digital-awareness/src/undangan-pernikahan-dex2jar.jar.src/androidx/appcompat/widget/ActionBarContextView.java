  ...
  extends AbsActionBarView
{
  ...
  public void initForMode(final ActionMode paramActionMode)
  {
    ...
    localObject = this.mClose.findViewById(R.id.action_mode_close_button);
    this.mCloseButton = ((View)localObject);
    ...
    localObject = (MenuBuilder)paramActionMode.getMenu();
    if (this.mActionMenuPresenter != null) {
    ...
    ((MenuBuilder)localObject).addMenuPresenter(this.mActionMenuPresenter, this.mPopupContext);
  ...
  public void killMode()
  {
    ...
    View localView = this.mCloseButton;
    if (localView != null) {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/widget/ActionBarContextView.class
