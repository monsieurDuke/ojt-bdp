...
public class DatabaseConfiguration
{
  ...
  public boolean isMigrationRequired(int paramInt1, int paramInt2)
  {
    ...
    if (this.requireMigration)
    {
      ...
      if ((localSet != null) && (!localSet.contains(Integer.valueOf(paramInt1)))) {}
    }
    else
    {
      bool = false;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/room/DatabaseConfiguration.class
