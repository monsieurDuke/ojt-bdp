  ...
  implements Runnable
{
  ...
  public static StatusRunnable<List<WorkInfo>> forStringIds(WorkManagerImpl paramWorkManagerImpl, final List<String> paramList)
  {
    new StatusRunnable()
    {
      ...
      {
        Object localObject = StatusRunnable.this.getWorkDatabase();
        localObject = ((WorkDatabase)localObject).workSpecDao().getWorkStatusPojoForIds(paramList);
        return (List)WorkSpec.WORK_INFO_MAPPER.apply(localObject);
      }
    };
  }
  ...
  public static StatusRunnable<List<WorkInfo>> forTag(WorkManagerImpl paramWorkManagerImpl, final String paramString)
  {
    new StatusRunnable()
    {
      ...
      {
        Object localObject = StatusRunnable.this.getWorkDatabase();
        localObject = ((WorkDatabase)localObject).workSpecDao().getWorkStatusPojoForTag(paramString);
        return (List)WorkSpec.WORK_INFO_MAPPER.apply(localObject);
      }
    };
  }
  ...
  public static StatusRunnable<WorkInfo> forUUID(WorkManagerImpl paramWorkManagerImpl, final UUID paramUUID)
  {
    new StatusRunnable()
    {
      ...
      {
        Object localObject = StatusRunnable.this.getWorkDatabase();
        localObject = ((WorkDatabase)localObject).workSpecDao().getWorkStatusPojoForId(paramUUID.toString());
        if (localObject != null) {
  ...
  public static StatusRunnable<List<WorkInfo>> forUniqueWork(WorkManagerImpl paramWorkManagerImpl, final String paramString)
  {
    new StatusRunnable()
    {
      ...
      {
        Object localObject = StatusRunnable.this.getWorkDatabase();
        localObject = ((WorkDatabase)localObject).workSpecDao().getWorkStatusPojoForName(paramString);
        return (List)WorkSpec.WORK_INFO_MAPPER.apply(localObject);
      }
    };
  }
  ...
  public static StatusRunnable<List<WorkInfo>> forWorkQuerySpec(WorkManagerImpl paramWorkManagerImpl, final WorkQuery paramWorkQuery)
  {
    new StatusRunnable()
    {
      ...
      {
        Object localObject = StatusRunnable.this.getWorkDatabase();
        localObject = ((WorkDatabase)localObject).rawWorkInfoDao().getWorkInfoPojos(RawQueries.workQueryToRawQuery(paramWorkQuery));
        return (List)WorkSpec.WORK_INFO_MAPPER.apply(localObject);
      }
    };
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/impl/utils/StatusRunnable.class
