  ...
  implements ListenableFuture<V>
{
  ...
  static
  {
    ...
    //   24: putstatic 84	androidx/work/impl/utils/futures/AbstractFuture:GENERATE_CANCELLATION_CAUSES	Z
    //   27: ldc 2
    ...
    //   35: putstatic 98	androidx/work/impl/utils/futures/AbstractFuture:log	Ljava/util/logging/Logger;
    //   38: aconst_null
    //   39: astore_0
    //   40: new 25	androidx/work/impl/utils/futures/AbstractFuture$SafeAtomicHelper
    //   43: astore_1
    //   44: aload_1
    //   45: ldc 34
    //   47: ldc 100
    ...
    //   90: invokespecial 117	androidx/work/impl/utils/futures/AbstractFuture$SafeAtomicHelper:<init>	(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;)V
    //   93: goto +12 -> 105
    //   96: astore_0
    //   97: new 31	androidx/work/impl/utils/futures/AbstractFuture$SynchronizedHelper
    //   100: dup
    //   101: invokespecial 119	androidx/work/impl/utils/futures/AbstractFuture$SynchronizedHelper:<init>	()V
    //   104: astore_1
    //   105: aload_1
    //   106: putstatic 121	androidx/work/impl/utils/futures/AbstractFuture:ATOMIC_HELPER	Landroidx/work/impl/utils/futures/AbstractFuture$AtomicHelper;
    //   109: aload_0
    //   110: ifnull +15 -> 125
    //   113: getstatic 98	androidx/work/impl/utils/futures/AbstractFuture:log	Ljava/util/logging/Logger;
    ...
    //   132: putstatic 135	androidx/work/impl/utils/futures/AbstractFuture:NULL	Ljava/lang/Object;
    //   135: return
    // Local variable table:
    //   start	length	slot	name	signature
    //   7	33	0	str	String
    //   96	26	0	localThrowable	Throwable
    //   43	63	1	localObject	Object
    // Exception table:
    //   from	to	target	type
    //   40	93	96	finally
  }
  ...
  static void complete(AbstractFuture<?> paramAbstractFuture)
  {
    ...
    paramAbstractFuture = paramAbstractFuture.clearListeners((Listener)localObject1);
    label95:
    for (;;)
    {
      ...
      Object localObject2 = ((Listener)localObject1).task;
      if ((localObject2 instanceof SetFuture))
      {
        SetFuture localSetFuture = (SetFuture)localObject2;
        localObject2 = localSetFuture.owner;
        if (((AbstractFuture)localObject2).value == localSetFuture)
        {
          localObject1 = getFutureValue(localSetFuture.future);
          if (ATOMIC_HELPER.casValue((AbstractFuture)localObject2, localSetFuture, localObject1))
          {
            localObject1 = paramAbstractFuture;
  ...
  static Object getFutureValue(ListenableFuture<?> paramListenableFuture)
  {
    ...
    //   4: ifeq +63 -> 67
    //   7: aload_0
    //   8: checkcast 2	androidx/work/impl/utils/futures/AbstractFuture
    //   11: getfield 231	androidx/work/impl/utils/futures/AbstractFuture:value	Ljava/lang/Object;
    //   14: astore_2
    //   15: aload_2
    //   16: astore_0
    //   17: aload_2
    ...
    //   21: ifeq +44 -> 65
    //   24: aload_2
    //   25: checkcast 14	androidx/work/impl/utils/futures/AbstractFuture$Cancellation
    //   28: astore_3
    //   29: aload_2
    //   30: astore_0
    //   31: aload_3
    //   32: getfield 286	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:wasInterrupted	Z
    //   35: ifeq +30 -> 65
    //   38: aload_3
    //   39: getfield 279	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:cause	Ljava/lang/Throwable;
    //   42: ifnull +19 -> 61
    //   45: new 14	androidx/work/impl/utils/futures/AbstractFuture$Cancellation
    //   48: dup
    //   49: iconst_0
    //   50: aload_3
    //   51: getfield 279	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:cause	Ljava/lang/Throwable;
    //   54: invokespecial 289	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:<init>	(ZLjava/lang/Throwable;)V
    //   57: astore_0
    //   58: goto +7 -> 65
    //   61: getstatic 293	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:CAUSELESS_CANCELLED	Landroidx/work/impl/utils/futures/AbstractFuture$Cancellation;
    //   64: astore_0
    //   65: aload_0
    //   66: areturn
    //   67: aload_0
    ...
    //   73: istore_1
    //   74: getstatic 84	androidx/work/impl/utils/futures/AbstractFuture:GENERATE_CANCELLATION_CAUSES	Z
    //   77: iconst_1
    //   78: ixor
    //   79: iload_1
    //   80: iand
    //   81: ifeq +7 -> 88
    //   84: getstatic 293	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:CAUSELESS_CANCELLED	Landroidx/work/impl/utils/futures/AbstractFuture$Cancellation;
    //   87: areturn
    //   88: aload_0
    //   89: invokestatic 148	androidx/work/impl/utils/futures/AbstractFuture:getUninterruptibly	(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    //   92: astore_2
    //   93: aload_2
    //   94: ifnonnull +12 -> 106
    //   97: getstatic 135	androidx/work/impl/utils/futures/AbstractFuture:NULL	Ljava/lang/Object;
    //   100: astore_2
    //   101: aload_2
    //   102: astore_0
    //   103: goto +5 -> 108
    ...
    //   109: areturn
    //   110: astore_0
    //   111: new 17	androidx/work/impl/utils/futures/AbstractFuture$Failure
    //   114: dup
    //   115: aload_0
    //   116: invokespecial 298	androidx/work/impl/utils/futures/AbstractFuture$Failure:<init>	(Ljava/lang/Throwable;)V
    //   119: areturn
    //   120: astore_2
    //   121: iload_1
    //   122: ifne +39 -> 161
    //   125: new 17	androidx/work/impl/utils/futures/AbstractFuture$Failure
    //   128: dup
    ...
    //   157: invokespecial 298	androidx/work/impl/utils/futures/AbstractFuture$Failure:<init>	(Ljava/lang/Throwable;)V
    //   160: areturn
    //   161: new 14	androidx/work/impl/utils/futures/AbstractFuture$Cancellation
    //   164: dup
    //   165: iconst_0
    //   166: aload_2
    //   167: invokespecial 289	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:<init>	(ZLjava/lang/Throwable;)V
    //   170: areturn
    //   171: astore_0
    //   172: new 17	androidx/work/impl/utils/futures/AbstractFuture$Failure
    //   175: dup
    //   176: aload_0
    //   177: invokevirtual 181	java/util/concurrent/ExecutionException:getCause	()Ljava/lang/Throwable;
    //   180: invokespecial 298	androidx/work/impl/utils/futures/AbstractFuture$Failure:<init>	(Ljava/lang/Throwable;)V
    //   183: areturn
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public final boolean cancel(boolean paramBoolean)
  {
    ...
    if ((i | localObject1 instanceof SetFuture) != 0)
    {
      ...
      do
      {
        while (ATOMIC_HELPER.casValue(localAbstractFuture, localObject1, localCancellation))
        {
          boolean bool3 = true;
          bool2 = true;
          if (paramBoolean) {
          ...
          if ((localObject1 instanceof AbstractFuture))
          {
            ...
            localObject1 = localAbstractFuture.value;
            if (localObject1 == null) {
              i = 1;
            } else {
              i = 0;
        ...
        localObject2 = localAbstractFuture.value;
        localObject1 = localObject2;
  ...
  protected boolean setFuture(ListenableFuture<? extends V> paramListenableFuture)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 349	androidx/work/impl/utils/futures/AbstractFuture:checkNotNull	(Ljava/lang/Object;)Ljava/lang/Object;
    //   4: pop
    //   5: aload_0
    //   6: getfield 231	androidx/work/impl/utils/futures/AbstractFuture:value	Ljava/lang/Object;
    //   9: astore_3
    //   10: aload_3
    //   11: astore_2
    //   12: aload_3
    ...
    //   22: ifeq +28 -> 50
    //   25: aload_1
    //   26: invokestatic 239	androidx/work/impl/utils/futures/AbstractFuture:getFutureValue	(Lcom/google/common/util/concurrent/ListenableFuture;)Ljava/lang/Object;
    //   29: astore_1
    //   30: getstatic 121	androidx/work/impl/utils/futures/AbstractFuture:ATOMIC_HELPER	Landroidx/work/impl/utils/futures/AbstractFuture$AtomicHelper;
    //   33: aload_0
    //   34: aconst_null
    //   35: aload_1
    //   36: invokevirtual 243	androidx/work/impl/utils/futures/AbstractFuture$AtomicHelper:casValue	(Landroidx/work/impl/utils/futures/AbstractFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    //   39: ifeq +9 -> 48
    //   42: aload_0
    //   43: invokestatic 363	androidx/work/impl/utils/futures/AbstractFuture:complete	(Landroidx/work/impl/utils/futures/AbstractFuture;)V
    //   46: iconst_1
    //   47: ireturn
    //   48: iconst_0
    //   49: ireturn
    //   50: new 28	androidx/work/impl/utils/futures/AbstractFuture$SetFuture
    //   53: dup
    //   54: aload_0
    //   55: aload_1
    //   56: invokespecial 481	androidx/work/impl/utils/futures/AbstractFuture$SetFuture:<init>	(Landroidx/work/impl/utils/futures/AbstractFuture;Lcom/google/common/util/concurrent/ListenableFuture;)V
    //   59: astore_2
    //   60: getstatic 121	androidx/work/impl/utils/futures/AbstractFuture:ATOMIC_HELPER	Landroidx/work/impl/utils/futures/AbstractFuture$AtomicHelper;
    //   63: aload_0
    //   64: aconst_null
    //   65: aload_2
    //   66: invokevirtual 243	androidx/work/impl/utils/futures/AbstractFuture$AtomicHelper:casValue	(Landroidx/work/impl/utils/futures/AbstractFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    //   69: ifeq +46 -> 115
    //   72: aload_1
    //   73: aload_2
    //   74: getstatic 487	androidx/work/impl/utils/futures/DirectExecutor:INSTANCE	Landroidx/work/impl/utils/futures/DirectExecutor;
    //   77: invokeinterface 489 3 0
    //   82: goto +31 -> 113
    //   85: astore_3
    //   86: new 17	androidx/work/impl/utils/futures/AbstractFuture$Failure
    //   89: astore_1
    //   90: aload_1
    //   91: aload_3
    //   92: invokespecial 298	androidx/work/impl/utils/futures/AbstractFuture$Failure:<init>	(Ljava/lang/Throwable;)V
    //   95: goto +8 -> 103
    //   98: astore_1
    //   99: getstatic 493	androidx/work/impl/utils/futures/AbstractFuture$Failure:FALLBACK_INSTANCE	Landroidx/work/impl/utils/futures/AbstractFuture$Failure;
    //   102: astore_1
    //   103: getstatic 121	androidx/work/impl/utils/futures/AbstractFuture:ATOMIC_HELPER	Landroidx/work/impl/utils/futures/AbstractFuture$AtomicHelper;
    //   106: aload_0
    //   107: aload_2
    //   108: aload_1
    //   109: invokevirtual 243	androidx/work/impl/utils/futures/AbstractFuture$AtomicHelper:casValue	(Landroidx/work/impl/utils/futures/AbstractFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    //   112: pop
    //   113: iconst_1
    //   114: ireturn
    //   115: aload_0
    //   116: getfield 231	androidx/work/impl/utils/futures/AbstractFuture:value	Ljava/lang/Object;
    //   119: astore_2
    //   120: aload_2
    //   121: instanceof 14
    //   124: ifeq +17 -> 141
    //   127: aload_1
    //   128: aload_2
    //   129: checkcast 14	androidx/work/impl/utils/futures/AbstractFuture$Cancellation
    //   132: getfield 286	androidx/work/impl/utils/futures/AbstractFuture$Cancellation:wasInterrupted	Z
  ...
  private static final class Failure
  {
    ...
    {
      this.exception = ((Throwable)AbstractFuture.checkNotNull(paramThrowable));
    }
  }
    ...
    extends AbstractFuture.AtomicHelper
  {
    ...
    {
      return AbstractResolvableFuture.SafeAtomicHelper..ExternalSyntheticBackportWithForwarding0.m(this.listenersUpdater, paramAbstractFuture, paramListener1, paramListener2);
    }
    
    boolean casValue(AbstractFuture<?> paramAbstractFuture, Object paramObject1, Object paramObject2)
    {
      return AbstractResolvableFuture.SafeAtomicHelper..ExternalSyntheticBackportWithForwarding0.m(this.valueUpdater, paramAbstractFuture, paramObject1, paramObject2);
    }
    ...
    {
      return AbstractResolvableFuture.SafeAtomicHelper..ExternalSyntheticBackportWithForwarding0.m(this.waitersUpdater, paramAbstractFuture, paramWaiter1, paramWaiter2);
    }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      Object localObject = AbstractFuture.getFutureValue(this.future);
      if (AbstractFuture.ATOMIC_HELPER.casValue(this.owner, this, localObject)) {
    ...
    extends AbstractFuture.AtomicHelper
  {
    ...
    boolean casListeners(AbstractFuture<?> paramAbstractFuture, AbstractFuture.Listener paramListener1, AbstractFuture.Listener paramListener2)
    {
      try
      {
        ...
        {
          paramAbstractFuture.listeners = paramListener2;
          return true;
        }
        return false;
      }
    ...
    boolean casValue(AbstractFuture<?> paramAbstractFuture, Object paramObject1, Object paramObject2)
    {
      try
      {
        ...
        {
          paramAbstractFuture.value = paramObject2;
          return true;
        }
        return false;
      }
    ...
    boolean casWaiters(AbstractFuture<?> paramAbstractFuture, AbstractFuture.Waiter paramWaiter1, AbstractFuture.Waiter paramWaiter2)
    {
      try
      {
        ...
        {
          paramAbstractFuture.waiters = paramWaiter2;
          return true;
        }
        return false;
      }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/impl/utils/futures/AbstractFuture.class
