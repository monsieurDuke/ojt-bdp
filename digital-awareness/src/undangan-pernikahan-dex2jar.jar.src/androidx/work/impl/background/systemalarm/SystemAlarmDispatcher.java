  ...
  implements ExecutionListener
{
  ...
  static
  {
    String str = Logger.tagWithPrefix("SystemAlarmDispatcher");
    Log5ECF72.a(str);
    LogE84000.a(str);
    Log229316.a(str);
    TAG = str;
  ...
  SystemAlarmDispatcher(Context paramContext, Processor paramProcessor, WorkManagerImpl paramWorkManagerImpl)
  {
    ...
    if (paramWorkManagerImpl != null) {
      paramContext = paramWorkManagerImpl;
    } else {
      paramContext = WorkManagerImpl.getInstance(paramContext);
    }
    this.mWorkManager = paramContext;
    if (paramProcessor == null) {
      paramProcessor = paramContext.getProcessor();
    }
  ...
  public boolean add(Intent paramIntent, int paramInt)
  {
    ...
    int i = 0;
    String str = String.format("Adding command %s (%s)", new Object[] { paramIntent, Integer.valueOf(paramInt) });
    Log5ECF72.a(str);
    LogE84000.a(str);
    Log229316.a(str);
  ...
  void dequeueAndCheckForCompletion()
  {
    ...
    synchronized (this.mIntents)
    {
      if (this.mCurrentIntent != null)
      {
        ...
        localObject4 = String.format("Removing command %s", new Object[] { this.mCurrentIntent });
        Log5ECF72.a(localObject4);
        LogE84000.a(localObject4);
        Log229316.a(localObject4);
        localLogger.debug((String)localObject2, (String)localObject4, new Throwable[0]);
      ...
      Object localObject4 = this.mTaskExecutor.getBackgroundExecutor();
      if ((!this.mCommandHandler.hasPendingCommands()) && (this.mIntents.isEmpty()) && (!((SerialExecutor)localObject4).hasPendingTasks()))
      {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/impl/background/systemalarm/SystemAlarmDispatcher.class
