  ...
  extends WorkDatabase
{
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration paramDatabaseConfiguration)
  {
    Object localObject = new RoomOpenHelper(paramDatabaseConfiguration, new RoomOpenHelper.Delegate(12)
    {
      ...
      {
        Object localObject3 = new HashMap(2);
        ((HashMap)localObject3).put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 1, null, 1));
        ((HashMap)localObject3).put("prerequisite_id", new TableInfo.Column("prerequisite_id", "TEXT", true, 2, null, 1));
        Object localObject1 = new HashSet(2);
        ...
        ((HashSet)localObject1).add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[] { "prerequisite_id" }), Arrays.asList(new String[] { "id" })));
        ...
        localObject1 = new TableInfo("Dependency", (Map)localObject3, (Set)localObject1, (Set)localObject2);
        localObject2 = TableInfo.read(paramAnonymousSupportSQLiteDatabase, "Dependency");
        ...
        ((HashMap)localObject1).put("out_of_quota_policy", new TableInfo.Column("out_of_quota_policy", "INTEGER", true, 0, null, 1));
        ...
        localObject3 = new HashSet(2);
        ((HashSet)localObject3).add(new TableInfo.Index("index_WorkSpec_schedule_requested_at", false, Arrays.asList(new String[] { "schedule_requested_at" })));
        ((HashSet)localObject3).add(new TableInfo.Index("index_WorkSpec_period_start_time", false, Arrays.asList(new String[] { "period_start_time" })));
        localObject1 = new TableInfo("WorkSpec", (Map)localObject1, (Set)localObject2, (Set)localObject3);
        localObject2 = TableInfo.read(paramAnonymousSupportSQLiteDatabase, "WorkSpec");
        if (!((TableInfo)localObject1).equals(localObject2)) {
        ...
        localObject2 = new TableInfo("WorkName", (Map)localObject3, (Set)localObject1, (Set)localObject2);
        ...
        localObject2 = new HashMap(2);
        ((HashMap)localObject2).put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 1, null, 1));
        ((HashMap)localObject2).put("progress", new TableInfo.Column("progress", "BLOB", true, 0, null, 1));
        localObject1 = new HashSet(1);
        ((HashSet)localObject1).add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[] { "work_spec_id" }), Arrays.asList(new String[] { "id" })));
        localObject2 = new TableInfo("WorkProgress", (Map)localObject2, (Set)localObject1, new HashSet(0));
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/impl/WorkDatabase_Impl.class
