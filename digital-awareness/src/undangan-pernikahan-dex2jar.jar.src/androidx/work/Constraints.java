...
public final class Constraints
{
  ...
  public int hashCode()
  {
    int j = this.mRequiredNetworkType.hashCode();
    int m = this.mRequiresCharging;
    int i = this.mRequiresDeviceIdle;
    int n = this.mRequiresBatteryNotLow;
    int i1 = this.mRequiresStorageNotLow;
    long l = this.mTriggerContentUpdateDelay;
    int k = (int)(l ^ l >>> 32);
    l = this.mTriggerMaxContentDelay;
    return ((((((j * 31 + m) * 31 + i) * 31 + n) * 31 + i1) * 31 + k) * 31 + (int)(l ^ l >>> 32)) * 31 + this.mContentUriTriggers.hashCode();
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/Constraints.class
