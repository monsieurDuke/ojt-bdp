  ...
  private ThreadFactory createDefaultThreadFactory(final boolean paramBoolean)
  {
    new ThreadFactory()
    {
      ...
      public Thread newThread(Runnable paramAnonymousRunnable)
      {
        ...
        return new Thread(paramAnonymousRunnable, str + this.mThreadCount.incrementAndGet());
      }
    };
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/Configuration.class
