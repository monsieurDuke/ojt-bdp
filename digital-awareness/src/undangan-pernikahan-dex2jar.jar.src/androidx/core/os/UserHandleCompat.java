...
public class UserHandleCompat
{
  ...
  public static UserHandle getUserHandleForUid(int paramInt)
  {
    ...
    try
    {
      Object localObject = (Integer)getGetUserIdMethod().invoke(null, new Object[] { Integer.valueOf(paramInt) });
      localObject = (UserHandle)getUserHandleConstructor().newInstance(new Object[] { localObject });
    ...
    catch (IllegalAccessException localIllegalAccessException)
    {
      ...
      localIllegalAccessError.initCause(localIllegalAccessException);
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/os/UserHandleCompat.class
