    ...
    static boolean isApplicationUid(int paramInt)
    {
      try
      {
        synchronized (sResolvedLock)
        {
          ...
          Object localObject1 = sMethodUserHandleIsAppMethod;
          if (localObject1 != null)
          {
            localObject1 = (Boolean)((Method)localObject1).invoke(null, new Object[] { Integer.valueOf(paramInt) });
            if (localObject1 != null) {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/os/ProcessCompat.class
