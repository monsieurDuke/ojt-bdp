  ...
  public static boolean hasCallbacks(Handler paramHandler, Runnable paramRunnable)
  {
    ...
    if (Build.VERSION.SDK_INT >= 16) {
      try
      {
        ...
        catch (NullPointerException localNullPointerException) {}catch (NoSuchMethodException localNoSuchMethodException) {}catch (IllegalAccessException localIllegalAccessException) {}
      }
    ...
    throw new UnsupportedOperationException("Failed to call Handler.hasCallbacks(), but there is no safe failure mode for this method. Raising exception.", localIllegalAccessException);
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/os/HandlerCompat.class
