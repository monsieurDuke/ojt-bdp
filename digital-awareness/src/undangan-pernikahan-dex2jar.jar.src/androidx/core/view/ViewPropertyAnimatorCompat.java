...
public final class ViewPropertyAnimatorCompat
{
  ...
  public ViewPropertyAnimatorCompat setUpdateListener(ViewPropertyAnimatorUpdateListener paramViewPropertyAnimatorUpdateListener)
  {
    ...
    {
      ViewPropertyAnimatorCompat..ExternalSyntheticLambda0 localExternalSyntheticLambda0 = null;
      if (paramViewPropertyAnimatorUpdateListener != null) {
        localExternalSyntheticLambda0 = new ViewPropertyAnimatorCompat..ExternalSyntheticLambda0(paramViewPropertyAnimatorUpdateListener, localView);
      }
      Api19Impl.setUpdateListener(localView.animate(), localExternalSyntheticLambda0);
    }
    return this;
  }
  ...
  {
    static ViewPropertyAnimator withEndAction(ViewPropertyAnimator paramViewPropertyAnimator, Runnable paramRunnable)
    {
      return paramViewPropertyAnimator.withEndAction(paramRunnable);
    }
    
    static ViewPropertyAnimator withLayer(ViewPropertyAnimator paramViewPropertyAnimator)
    {
      return paramViewPropertyAnimator.withLayer();
    }
    
    static ViewPropertyAnimator withStartAction(ViewPropertyAnimator paramViewPropertyAnimator, Runnable paramRunnable)
    {
  ...
  {
    static Interpolator getInterpolator(ViewPropertyAnimator paramViewPropertyAnimator)
    {
  ...
  {
    static ViewPropertyAnimator setUpdateListener(ViewPropertyAnimator paramViewPropertyAnimator, ValueAnimator.AnimatorUpdateListener paramAnimatorUpdateListener)
    {
  ...
  {
    static ViewPropertyAnimator translationZ(ViewPropertyAnimator paramViewPropertyAnimator, float paramFloat)
    {
      return paramViewPropertyAnimator.translationZ(paramFloat);
    }
    
    static ViewPropertyAnimator translationZBy(ViewPropertyAnimator paramViewPropertyAnimator, float paramFloat)
    {
      return paramViewPropertyAnimator.translationZBy(paramFloat);
    }
    
    static ViewPropertyAnimator z(ViewPropertyAnimator paramViewPropertyAnimator, float paramFloat)
    {
      return paramViewPropertyAnimator.z(paramFloat);
    }
    
    static ViewPropertyAnimator zBy(ViewPropertyAnimator paramViewPropertyAnimator, float paramFloat)
    {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/view/ViewPropertyAnimatorCompat.class
