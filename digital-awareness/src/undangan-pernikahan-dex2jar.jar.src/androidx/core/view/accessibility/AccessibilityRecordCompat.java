...
public class AccessibilityRecordCompat
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return paramObject.equals(localAccessibilityRecordCompat.mRecord);
  }
  ...
  {
    static int getMaxScrollX(AccessibilityRecord paramAccessibilityRecord)
    {
      return paramAccessibilityRecord.getMaxScrollX();
    }
    
    static int getMaxScrollY(AccessibilityRecord paramAccessibilityRecord)
    {
      return paramAccessibilityRecord.getMaxScrollY();
    }
    
    static void setMaxScrollX(AccessibilityRecord paramAccessibilityRecord, int paramInt)
    {
      paramAccessibilityRecord.setMaxScrollX(paramInt);
    }
    
    static void setMaxScrollY(AccessibilityRecord paramAccessibilityRecord, int paramInt)
    {
  ...
  {
    static void setSource(AccessibilityRecord paramAccessibilityRecord, View paramView, int paramInt)
    {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/view/accessibility/AccessibilityRecordCompat.class
