...
public class AccessibilityNodeInfoCompat
{
  ...
  private void removeCollectedSpans(View paramView)
  {
    ...
    if (paramView != null)
    {
      ...
      for (i = 0; i < localArrayList.size(); i++) {
        paramView.remove(((Integer)localArrayList.get(i)).intValue());
      }
    }
  }
  ...
  public CharSequence getText()
  {
    if (hasSpans())
    {
      ...
      List localList4 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_END_KEY");
      List localList3 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY");
      List localList2 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY");
      Object localObject = TextUtils.substring(this.mInfo.getText(), 0, this.mInfo.getText().length());
      Log5ECF72.a(localObject);
      LogE84000.a(localObject);
      Log229316.a(localObject);
      localObject = new SpannableString((CharSequence)localObject);
      for (int i = 0; i < localList1.size(); i++) {
        ((Spannable)localObject).setSpan(new AccessibilityClickableSpanCompat(((Integer)localList2.get(i)).intValue(), this, getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer)localList1.get(i)).intValue(), ((Integer)localList4.get(i)).intValue(), ((Integer)localList3.get(i)).intValue());
      }
  ...
  {
    if (Build.VERSION.SDK_INT >= 26) {
      this.mInfo.setAvailableExtraData(paramList);
    }
  }
  ...
  public String toString()
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      for (i = 0; i < localList.size(); i++)
      {
        ...
        String str = getActionSymbolicName(localAccessibilityActionCompat.getId());
        Log5ECF72.a(str);
        LogE84000.a(str);
        Log229316.a(str);
        localObject = str;
    ...
    else
    {
      ...
      while (i != 0)
      {
        ...
        i &= (j ^ 0xFFFFFFFF);
        localObject = getActionSymbolicName(j);
        Log5ECF72.a(localObject);
        LogE84000.a(localObject);
        Log229316.a(localObject);
        localStringBuilder.append((String)localObject);
  ...
  public static class AccessibilityActionCompat
  {
    ...
    public boolean perform(View paramView, Bundle paramBundle)
    {
      if (this.mCommand != null)
      {
        ...
        AccessibilityViewCommand.CommandArguments localCommandArguments = null;
        Class localClass = this.mViewCommandArgumentClass;
        if (localClass != null)
        {
          localObject = localCommandArguments;
          try
          {
            localCommandArguments = (AccessibilityViewCommand.CommandArguments)localClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
            localObject = localCommandArguments;
          ...
          {
            paramBundle = this.mViewCommandArgumentClass;
            if (paramBundle == null) {
              paramBundle = "null";
            } else {
              paramBundle = paramBundle.getName();
            }
            Log.e("A11yActionCompat", "Failed to execute command with argument class ViewCommandArgument: " + paramBundle, localException);
          }
        }
        return this.mCommand.perform(paramView, (AccessibilityViewCommand.CommandArguments)localObject);
      }
      return false;
    }
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/view/accessibility/AccessibilityNodeInfoCompat.class
