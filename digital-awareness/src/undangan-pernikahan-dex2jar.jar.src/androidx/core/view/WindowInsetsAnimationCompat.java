...
public final class WindowInsetsAnimationCompat
{
    ...
    extends WindowInsetsAnimationCompat.Impl
  {
    ...
    static void dispatchOnProgress(View paramView, WindowInsetsCompat paramWindowInsetsCompat, List<WindowInsetsAnimationCompat> paramList)
    {
      ...
      if (localCallback != null)
      {
        paramWindowInsetsCompat = localCallback.onProgress(localWindowInsetsCompat, paramList);
        if (localCallback.getDispatchMode() == 0) {
          return;
        }
      }
      if ((paramView instanceof ViewGroup))
      {
        paramView = (ViewGroup)paramView;
        for (int i = 0; i < paramView.getChildCount(); i++) {
          dispatchOnProgress(paramView.getChildAt(i), paramWindowInsetsCompat, paramList);
        }
      }
    }
    ...
    {
      Object localObject = paramView.getTag(R.id.tag_window_insets_animation_callback);
      paramView = null;
      if ((localObject instanceof Impl21OnApplyWindowInsetsListener)) {
        paramView = ((Impl21OnApplyWindowInsetsListener)localObject).mCallback;
      }
      return paramView;
    }
    ...
    static WindowInsetsCompat interpolateInsets(WindowInsetsCompat paramWindowInsetsCompat1, WindowInsetsCompat paramWindowInsetsCompat2, float paramFloat, int paramInt)
    {
      ...
      while (i <= 256)
      {
        ...
        {
          Insets localInsets2 = paramWindowInsetsCompat1.getInsets(i);
          Insets localInsets1 = paramWindowInsetsCompat2.getInsets(i);
          localBuilder.setInsets(i, WindowInsetsCompat.insetInsets(localInsets2, (int)((localInsets2.left - localInsets1.left) * (1.0F - paramFloat) + 0.5D), (int)((localInsets2.top - localInsets1.top) * (1.0F - paramFloat) + 0.5D), (int)((localInsets2.right - localInsets1.right) * (1.0F - paramFloat) + 0.5D), (int)((localInsets2.bottom - localInsets1.bottom) * (1.0F - paramFloat) + 0.5D)));
        }
        i <<= 1;
      }
      ...
      implements View.OnApplyWindowInsetsListener
    {
      ...
      public WindowInsets onApplyWindowInsets(final View paramView, WindowInsets paramWindowInsets)
      {
        ...
        final ValueAnimator localValueAnimator = ValueAnimator.ofFloat(new float[] { 0.0F, 1.0F }).setDuration(localWindowInsetsAnimationCompat.getDurationMillis());
        localObject = WindowInsetsAnimationCompat.Impl21.computeAnimationBounds(localWindowInsetsCompat1, localWindowInsetsCompat2, i);
        ...
        localValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
        {
          public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
          {
            ...
            WindowInsetsCompat localWindowInsetsCompat = WindowInsetsAnimationCompat.Impl21.interpolateInsets(localWindowInsetsCompat1, localWindowInsetsCompat2, localWindowInsetsAnimationCompat.getInterpolatedFraction(), i);
            paramAnonymousValueAnimator = Collections.singletonList(localWindowInsetsAnimationCompat);
            WindowInsetsAnimationCompat.Impl21.dispatchOnProgress(paramView, localWindowInsetsCompat, paramAnonymousValueAnimator);
          }
        });
        ...
        OneShotPreDrawListener.add(paramView, new Runnable()
        {
          public void run()
          {
            WindowInsetsAnimationCompat.Impl21.dispatchOnStart(paramView, localWindowInsetsAnimationCompat, localObject);
    ...
    extends WindowInsetsAnimationCompat.Impl
  {
      ...
      extends WindowInsetsAnimation.Callback
    {
      ...
      public WindowInsets onProgress(WindowInsets paramWindowInsets, List<WindowInsetsAnimation> paramList)
      {
        ...
        {
          localObject = (WindowInsetsAnimation)paramList.get(i);
          WindowInsetsAnimationCompat localWindowInsetsAnimationCompat = getWindowInsetsAnimationCompat((WindowInsetsAnimation)localObject);
          localWindowInsetsAnimationCompat.setFraction(((WindowInsetsAnimation)localObject).getFraction());
          this.mTmpRunningAnimations.add(localWindowInsetsAnimationCompat);
        }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/view/WindowInsetsAnimationCompat.class
