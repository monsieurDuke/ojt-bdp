...
final class GradientColorInflaterCompat
{
    ...
    throws IOException, XmlPullParserException
  {
    ...
    if (((String)localObject).equals("gradient"))
    {
      ...
      float f4 = TypedArrayUtils.getNamedFloat((TypedArray)localObject, paramXmlPullParser, "startY", R.styleable.GradientColor_android_startY, 0.0F);
      float f6 = TypedArrayUtils.getNamedFloat((TypedArray)localObject, paramXmlPullParser, "endX", R.styleable.GradientColor_android_endX, 0.0F);
      float f1 = TypedArrayUtils.getNamedFloat((TypedArray)localObject, paramXmlPullParser, "endY", R.styleable.GradientColor_android_endY, 0.0F);
      float f2 = TypedArrayUtils.getNamedFloat((TypedArray)localObject, paramXmlPullParser, "centerX", R.styleable.GradientColor_android_centerX, 0.0F);
      float f7 = TypedArrayUtils.getNamedFloat((TypedArray)localObject, paramXmlPullParser, "centerY", R.styleable.GradientColor_android_centerY, 0.0F);
      ...
      float f5 = TypedArrayUtils.getNamedFloat((TypedArray)localObject, paramXmlPullParser, "gradientRadius", R.styleable.GradientColor_android_gradientRadius, 0.0F);
      ...
      {
      default: 
        return new LinearGradient(f3, f4, f6, f1, paramResources.mColors, paramResources.mOffsets, parseTileMode(n));
      case 2: 
        return new SweepGradient(f2, f7, paramResources.mColors, paramResources.mOffsets);
      }
      if (f5 > 0.0F) {
        return new RadialGradient(f2, f7, f5, paramResources.mColors, paramResources.mOffsets, parseTileMode(n));
      }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if ((k == 2) && (j <= i) && (paramXmlPullParser.getName().equals("item")))
      {
        ...
        boolean bool2 = localTypedArray.hasValue(R.styleable.GradientColorItem_android_color);
        boolean bool1 = localTypedArray.hasValue(R.styleable.GradientColorItem_android_offset);
        if ((!bool2) || (!bool1)) {
          break;
        }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/content/res/GradientColorInflaterCompat.class
