...
public class NotificationCompat
{
  ...
  static Action getActionCompatFromAction(Notification.Action paramAction)
  {
    ...
    {
      localObject2 = new RemoteInput[arrayOfRemoteInput.length];
      for (i = 0;; i++)
      {
        ...
        localObject1 = arrayOfRemoteInput[i];
        String str = ((android.app.RemoteInput)localObject1).getResultKey();
        CharSequence localCharSequence = ((android.app.RemoteInput)localObject1).getLabel();
        CharSequence[] arrayOfCharSequence = ((android.app.RemoteInput)localObject1).getChoices();
        bool1 = ((android.app.RemoteInput)localObject1).getAllowFreeFormInput();
        int j;
        if (Build.VERSION.SDK_INT >= 29) {
          j = ((android.app.RemoteInput)localObject1).getEditChoicesBeforeSending();
        } else {
          j = 0;
        }
        localObject2[i] = new RemoteInput(str, localCharSequence, arrayOfCharSequence, bool1, j, ((android.app.RemoteInput)localObject1).getExtras(), null);
      }
    }
    ...
    boolean bool4 = paramAction.getExtras().getBoolean("android.support.action.showsUserInterface", true);
    ...
    if (Build.VERSION.SDK_INT >= 31) {
      bool3 = paramAction.isAuthenticationRequired();
    }
    if (Build.VERSION.SDK_INT >= 23)
    {
      if ((paramAction.getIcon() == null) && (paramAction.icon != 0)) {
        return new Action(paramAction.icon, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), (RemoteInput[])localObject1, null, bool1, i, bool4, bool2, bool3);
      }
      if (paramAction.getIcon() == null) {
        localObject2 = null;
      } else {
        localObject2 = IconCompat.createFromIconOrNullIfZeroResId(paramAction.getIcon());
      }
      return new Action((IconCompat)localObject2, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), (RemoteInput[])localObject1, null, bool1, i, bool4, bool2, bool3);
    }
    return new Action(paramAction.icon, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), (RemoteInput[])localObject1, null, bool1, i, bool4, bool2, bool3);
  }
    ...
    if (Build.VERSION.SDK_INT >= 19)
    {
      ...
      if (paramNotification != null) {
        for (int i = 0; i < paramNotification.size(); i++)
        {
          ...
          LogE84000.a(str);
          Log229316.a(str);
          localArrayList.add(NotificationCompatJellybean.getActionFromBundle(paramNotification.getBundle(str)));
        }
      }
    }
    return localArrayList;
  ...
  public static LocusIdCompat getLocusId(Notification paramNotification)
  {
    ...
    if (i >= 29)
    {
      ...
      if (paramNotification == null) {
        ...
        paramNotification = LocusIdCompat.toLocusIdCompat(paramNotification);
      }
  ...
  public static class Action
  {
    ...
    Action(int paramInt1, CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput1, RemoteInput[] paramArrayOfRemoteInput2, boolean paramBoolean1, int paramInt2, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
    {
    ...
    Action(IconCompat paramIconCompat, CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput1, RemoteInput[] paramArrayOfRemoteInput2, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
    {
      ...
      if (paramBundle != null) {
        paramIconCompat = paramBundle;
      } else {
        paramIconCompat = new Bundle();
      }
      this.mExtras = paramIconCompat;
      ...
      this.mAuthenticationRequired = paramBoolean4;
    }
    ...
    public static final class Builder
    {
      ...
      {
        this(paramAction.getIconCompat(), paramAction.title, paramAction.actionIntent, new Bundle(paramAction.mExtras), paramAction.getRemoteInputs(), paramAction.getAllowGeneratedReplies(), paramAction.getSemanticAction(), paramAction.mShowsUserInterface, paramAction.isContextual(), paramAction.isAuthenticationRequired());
      }
      ...
      private Builder(IconCompat paramIconCompat, CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
      {
        this.mIcon = paramIconCompat;
      ...
      public static Builder fromAndroidAction(Notification.Action paramAction)
      {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
          localBuilder.setAuthenticationRequired(paramAction.isAuthenticationRequired());
        }
        return localBuilder;
      }
      ...
      public NotificationCompat.Action build()
      {
        ...
        return new NotificationCompat.Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, (RemoteInput[])localObject2, (RemoteInput[])localObject1, this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface, this.mIsContextual, this.mAuthenticationRequired);
      }
      ...
      {
        this.mAuthenticationRequired = paramBoolean;
        return this;
      }
    ...
    extends NotificationCompat.Style
  {
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      if (Build.VERSION.SDK_INT >= 16)
      {
        ...
        if (Build.VERSION.SDK_INT >= 31)
        {
          Api31Impl.showBigPictureWhenCollapsed(localBigPictureStyle, this.mShowBigPictureWhenCollapsed);
          Api31Impl.setContentDescription(localBigPictureStyle, this.mPictureContentDescription);
        }
      }
    }
    ...
    protected void restoreFromCompatExtras(Bundle paramBundle)
    {
      ...
      this.mShowBigPictureWhenCollapsed = paramBundle.getBoolean("android.showBigPictureWhenCollapsed");
    }
    ...
    public BigPictureStyle setContentDescription(CharSequence paramCharSequence)
    {
      this.mPictureContentDescription = paramCharSequence;
      return this;
    }
    ...
    {
      this.mShowBigPictureWhenCollapsed = paramBoolean;
      return this;
    }
    ...
    {
      static void setContentDescription(Notification.BigPictureStyle paramBigPictureStyle, CharSequence paramCharSequence)
      {
        paramBigPictureStyle.setContentDescription(paramCharSequence);
      }
      
      static void showBigPictureWhenCollapsed(Notification.BigPictureStyle paramBigPictureStyle, boolean paramBoolean)
      {
  ...
  public static final class BubbleMetadata
  {
    ...
    public static final class Builder
    {
      ...
      public NotificationCompat.BubbleMetadata build()
      {
        ...
        if ((localObject == null) && (this.mPendingIntent == null)) {
          throw new NullPointerException("Must supply pending intent or shortcut to bubble");
        }
        if ((localObject == null) && (this.mIcon == null)) {
          throw new NullPointerException("Must supply an icon or shortcut for the bubble");
        }
        localObject = new NotificationCompat.BubbleMetadata(this.mPendingIntent, this.mDeleteIntent, this.mIcon, this.mDesiredHeight, this.mDesiredHeightResId, this.mFlags, this.mShortcutId, null);
  ...
  public static class Builder
  {
    ...
    private Bitmap reduceLargeIconSize(Bitmap paramBitmap)
    {
      if ((paramBitmap != null) && (Build.VERSION.SDK_INT < 27))
      {
        ...
        int j = localResources.getDimensionPixelSize(R.dimen.compat_notification_large_icon_max_width);
        int i = localResources.getDimensionPixelSize(R.dimen.compat_notification_large_icon_max_height);
    ...
    {
      this.mFgsDeferBehavior = paramInt;
      return this;
    }
    ...
    public Builder setLights(int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      paramInt1 = this.mNotification.ledOnMS;
      paramInt2 = 1;
      if ((paramInt1 != 0) && (this.mNotification.ledOffMS != 0)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
      Notification localNotification = this.mNotification;
      paramInt3 = localNotification.flags;
      if (paramInt1 != 0) {
        paramInt1 = paramInt2;
      } else {
        paramInt1 = 0;
      }
      localNotification.flags = (paramInt1 | paramInt3 & 0xFFFFFFFE);
      return this;
    }
    ...
    implements NotificationCompat.Extender
  {
    ...
    private static Bundle getBundleForUnreadConversation(UnreadConversation paramUnreadConversation)
    {
      ...
      for (int i = 0; i < arrayOfParcelable.length; i++)
      {
        ...
        localBundle1.putString("author", (String)localObject);
        arrayOfParcelable[i] = localBundle1;
      }
      localBundle2.putParcelableArray("messages", arrayOfParcelable);
      localObject = paramUnreadConversation.getRemoteInput();
      if (localObject != null) {
        localBundle2.putParcelable("remote_input", new RemoteInput.Builder(((RemoteInput)localObject).getResultKey()).setLabel(((RemoteInput)localObject).getLabel()).setChoices(((RemoteInput)localObject).getChoices()).setAllowFreeFormInput(((RemoteInput)localObject).getAllowFreeFormInput()).addExtras(((RemoteInput)localObject).getExtras()).build());
      }
    ...
    private static UnreadConversation getUnreadConversationFromBundle(Bundle paramBundle)
    {
      ...
      if ((arrayOfString2 != null) && (arrayOfString2.length == 1))
      {
        ...
        {
          localObject = localRemoteInput.getResultKey();
          ...
          localObject = new RemoteInput((String)localObject, localCharSequence, arrayOfCharSequence, bool, i, localRemoteInput.getExtras(), null);
        }
        else
        {
          localObject = null;
        }
        return new UnreadConversation(arrayOfString1, (RemoteInput)localObject, localPendingIntent1, localPendingIntent2, arrayOfString2, paramBundle.getLong("timestamp"));
      }
      return null;
    }
    ...
    public static class UnreadConversation
    {
      ...
      public static class Builder
      {
        ...
        public NotificationCompat.CarExtender.UnreadConversation build()
        {
          ...
          PendingIntent localPendingIntent2 = this.mReplyPendingIntent;
          PendingIntent localPendingIntent1 = this.mReadPendingIntent;
          long l = this.mLatestTimestamp;
          return new NotificationCompat.CarExtender.UnreadConversation(arrayOfString, localRemoteInput, localPendingIntent2, localPendingIntent1, new String[] { localObject }, l);
        }
        ...
        if (localList != null)
        {
          ...
          if (n > 0)
          {
            ...
            for (j = 0;; j++)
            {
              ...
              RemoteViews localRemoteViews2 = generateActionButton((NotificationCompat.Action)localList.get(j));
    ...
    extends NotificationCompat.Style
  {
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      if (Build.VERSION.SDK_INT >= 16)
      {
        ...
        paramNotificationBuilderWithBuilderAccessor = this.mTexts.iterator();
    ...
    extends NotificationCompat.Style
  {
    ...
    private CharSequence makeMessageLine(Message paramMessage)
    {
      ...
      {
        localObject2 = this.mUser.getName();
  ...
  public static abstract class Style
  {
    ...
    private int calculateTopPadding()
    {
      ...
      int j = localResources.getDimensionPixelSize(R.dimen.notification_top_pad);
      int i = localResources.getDimensionPixelSize(R.dimen.notification_top_pad_large_text);
      float f = (constrain(localResources.getConfiguration().fontScale, 1.0F, 1.3F) - 1.0F) / 0.29999995F;
      return Math.round((1.0F - f) * j + i * f);
    }
    ...
    private Bitmap createColoredBitmap(IconCompat paramIconCompat, int paramInt1, int paramInt2)
    {
      ...
      paramIconCompat = Bitmap.createBitmap(i, paramInt2, Bitmap.Config.ARGB_8888);
      localDrawable.setBounds(0, 0, i, paramInt2);
      if (paramInt1 != 0) {
    ...
    public RemoteViews applyStandardTemplate(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
    {
      ...
      else if ((paramBoolean1) && (this.mBuilder.mNotification.icon != 0))
      {
        ...
        if (Build.VERSION.SDK_INT >= 21)
        {
          int m = localResources.getDimensionPixelSize(R.dimen.notification_large_icon_width);
          ...
          localObject = createIconWithBackground(this.mBuilder.mNotification.icon, m - paramInt, j, this.mBuilder.getColor());
    ...
    implements NotificationCompat.Extender
  {
    ...
    private static Notification.Action getActionFromActionCompat(NotificationCompat.Action paramAction)
    {
      ...
      else
      {
        ...
        {
          i = j;
          if (((IconCompat)localObject).getType() == 2) {
      ...
      if (Build.VERSION.SDK_INT >= 31) {
        ((Notification.Action.Builder)localObject).setAuthenticationRequired(paramAction.isAuthenticationRequired());
      }
    ...
    public NotificationCompat.Builder extend(NotificationCompat.Builder paramBuilder)
    {
      ...
      if (!this.mActions.isEmpty()) {
        if (Build.VERSION.SDK_INT >= 16)
        {
          ...
          localObject = this.mActions.iterator();
          while (((Iterator)localObject).hasNext())
          {
            NotificationCompat.Action localAction = (NotificationCompat.Action)((Iterator)localObject).next();
            if (Build.VERSION.SDK_INT >= 20) {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/app/NotificationCompat.class
