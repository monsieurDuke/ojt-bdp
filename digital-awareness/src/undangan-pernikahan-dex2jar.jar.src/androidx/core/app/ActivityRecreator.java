...
final class ActivityRecreator
{
  ...
  static boolean recreate(Activity paramActivity)
  {
    ...
    try
    {
      Object localObject3 = tokenField.get(paramActivity);
      if (localObject3 == null) {
        return false;
      }
      Object localObject1 = mainThreadField.get(paramActivity);
      ...
      local1.<init>(localLifecycleCheckCallbacks, localObject3);
      localHandler.post(local1);
      try
      {
        if (needsRelaunchCall()) {
          requestRelaunchActivityMethod.invoke(localObject1, new Object[] { localObject3, null, null, Integer.valueOf(0), Boolean.valueOf(false), null, null, Boolean.valueOf(false), Boolean.valueOf(false) });
        } else {
          paramActivity.recreate();
        }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/app/ActivityRecreator.class
