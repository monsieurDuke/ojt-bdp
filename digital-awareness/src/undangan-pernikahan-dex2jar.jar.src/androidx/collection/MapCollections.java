    ...
    implements Set<Map.Entry<K, V>>
  {
    ...
    public int hashCode()
    {
      ...
      for (int i = MapCollections.this.colGetSize() - 1; i >= 0; i--)
      {
        ...
        localObject1 = MapCollections.this.colGetEntry(i, 1);
        int k;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/collection/MapCollections.class
