  ...
  extends Transition
{
  ...
  private void captureValues(TransitionValues paramTransitionValues)
  {
    ...
    if (this.mReparent)
    {
      ...
      ViewUtils.transformMatrixToGlobal((View)localObject, localMatrix);
      localMatrix.preTranslate(-((ViewGroup)localObject).getScrollX(), -((ViewGroup)localObject).getScrollY());
      paramTransitionValues.values.put("android:changeTransform:parentMatrix", localMatrix);
  ...
  private void createGhostView(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    ...
    paramViewGroup.addListener(new GhostListener(localView, (GhostView)localObject));
  ...
  {
    boolean bool3 = false;
    boolean bool4 = isValidTarget(paramViewGroup1);
    boolean bool1 = false;
    boolean bool2 = false;
    if ((bool4) && (isValidTarget(paramViewGroup2)))
    {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/transition/ChangeTransform.class
