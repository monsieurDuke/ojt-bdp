  ...
  implements Sink
{
  ...
  private final void deflate(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      Segment localSegment = localBuffer.writableSegment$okio(1);
      int i;
      if (paramBoolean) {
    ...
    throws IOException
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 135	okio/DeflaterSink:closed	Z
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: aconst_null
    //   9: checkcast 137	java/lang/Throwable
    //   12: astore_2
    //   13: aload_0
    //   14: invokevirtual 139	okio/DeflaterSink:finishDeflate$okio	()V
    //   17: goto +4 -> 21
    //   20: astore_2
    //   21: aload_0
    //   22: getfield 58	okio/DeflaterSink:deflater	Ljava/util/zip/Deflater;
    //   25: invokevirtual 142	java/util/zip/Deflater:end	()V
    //   28: aload_2
    //   29: astore_1
    //   30: goto +12 -> 42
    //   33: astore_3
    ...
    //   65: aload_0
    //   66: iconst_1
    //   67: putfield 135	okio/DeflaterSink:closed	Z
    //   70: aload_2
    //   71: ifnonnull +4 -> 75
    //   74: return
    //   75: aload_2
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okio/DeflaterSink.class
