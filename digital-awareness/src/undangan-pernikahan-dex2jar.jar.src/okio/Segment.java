...
public final class Segment
{
  ...
  public final void compact()
  {
    ...
    if (i != 0)
    {
      ...
      int m = this.limit - this.pos;
      localSegment1 = this.prev;
      Intrinsics.checkNotNull(localSegment1);
      int k = localSegment1.limit;
      localSegment1 = this.prev;
      Intrinsics.checkNotNull(localSegment1);
  ...
  public final void writeTo(Segment paramSegment, int paramInt)
  {
    ...
    {
      int j = paramSegment.limit;
      if (j + paramInt > 8192) {
        if (!paramSegment.shared)
        {
          i = paramSegment.pos;
          if (j + paramInt - i <= 8192)
          {
            arrayOfByte1 = paramSegment.data;
            ArraysKt.copyInto$default(arrayOfByte1, arrayOfByte1, 0, i, j, 2, null);
  ...
  @Metadata(bv={1, 0, 3}, d1={"\000\024\n\002\030\002\n\002\020\000\n\002\b\002\n\002\020\b\n\002\b\002\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002R\016\020\003\032\0020\004XT¢\006\002\n\000R\016\020\005\032\0020\004XT¢\006\002\n\000¨\006\006"}, d2={"Lokio/Segment$Companion;", "", "()V", "SHARE_MINIMUM", "", "SIZE", "okio"}, k=1, mv={1, 4, 0})
  public static final class Companion {}
}


/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okio/Segment.class
