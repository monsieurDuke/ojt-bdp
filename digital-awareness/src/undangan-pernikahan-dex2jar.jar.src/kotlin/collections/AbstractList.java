  ...
  implements List<E>, KMappedMarker
{
  ...
  {
    Object localObject = (List)this;
    int i = 0;
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      if (Intrinsics.areEqual(((Iterator)localObject).next(), paramE)) {
        return i;
      }
      i++;
    }
  ...
  public int lastIndexOf(E paramE)
  {
    ...
    while (((ListIterator)localObject).hasPrevious()) {
      if (Intrinsics.areEqual(((ListIterator)localObject).previous(), paramE)) {
        return ((ListIterator)localObject).nextIndex();
      }
    }
    int i = -1;
    return i;
  ...
  public static final class Companion
  {
    ...
    public final boolean orderedEquals$kotlin_stdlib(Collection<?> paramCollection1, Collection<?> paramCollection2)
    {
      ...
      while (paramCollection1.hasNext()) {
        if (!Intrinsics.areEqual(paramCollection1.next(), paramCollection2.next())) {
          return false;
        }
      }
      return true;
  ...
  @Metadata(d1={"\000\034\n\002\030\002\n\002\020(\n\002\b\002\n\002\020\b\n\002\b\005\n\002\020\013\n\002\b\003\b\004\030\0002\b\022\004\022\0028\0000\001B\005¢\006\002\020\002J\t\020\t\032\0020\nH\002J\016\020\013\032\0028\000H\002¢\006\002\020\fR\032\020\003\032\0020\004X\016¢\006\016\n\000\032\004\b\005\020\006\"\004\b\007\020\b¨\006\r"}, d2={"Lkotlin/collections/AbstractList$IteratorImpl;", "", "(Lkotlin/collections/AbstractList;)V", "index", "", "getIndex", "()I", "setIndex", "(I)V", "hasNext", "", "next", "()Ljava/lang/Object;", "kotlin-stdlib"}, k=1, mv={1, 7, 1}, xi=48)
    ...
    implements RandomAccess
  {
    ...
    public SubList(AbstractList<? extends E> paramAbstractList, int paramInt1, int paramInt2)
    {
      ...
      AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(paramInt1, paramInt2, paramAbstractList.size());
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/kotlin/collections/AbstractList.class
