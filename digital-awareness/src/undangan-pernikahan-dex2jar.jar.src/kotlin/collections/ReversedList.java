  ...
  extends AbstractMutableList<T>
{
  ...
  {
    this.delegate.add(CollectionsKt__ReversedViewsKt.access$reversePositionIndex((List)this, paramInt), paramT);
  }
  ...
  {
    return (T)this.delegate.get(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)this, paramInt));
  }
  ...
  {
    return (T)this.delegate.remove(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)this, paramInt));
  }
  
  public T set(int paramInt, T paramT)
  {
    return (T)this.delegate.set(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)this, paramInt), paramT);
  }
}


/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/kotlin/collections/ReversedList.class
