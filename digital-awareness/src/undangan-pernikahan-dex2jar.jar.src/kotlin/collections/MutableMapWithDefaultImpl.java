  ...
  implements MutableMapWithDefault<K, V>
{
  ...
  public V getOrImplicitDefault(K paramK)
  {
    ...
    if ((localObject == null) && (!localMap.containsKey(paramK))) {
      paramK = this.jdField_default.invoke(paramK);
    } else {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/kotlin/collections/MutableMapWithDefaultImpl.class
