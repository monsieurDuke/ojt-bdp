  ...
  implements Sequence<File>
{
  ...
  @Metadata(d1={"\000\022\n\002\030\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\b\"\030\0002\0020\001B\r\022\006\020\002\032\0020\003¢\006\002\020\004¨\006\005"}, d2={"Lkotlin/io/FileTreeWalk$DirectoryState;", "Lkotlin/io/FileTreeWalk$WalkState;", "rootDir", "Ljava/io/File;", "(Ljava/io/File;)V", "kotlin-stdlib"}, k=1, mv={1, 7, 1}, xi=48)
    ...
    extends AbstractIterator<File>
  {
    ...
    public FileTreeWalkIterator()
    {
      ...
      this.state = localArrayDeque;
      if (FileTreeWalk.access$getStart$p(this$1).isDirectory()) {
        localArrayDeque.push(directoryState(FileTreeWalk.access$getStart$p(this$1)));
      } else if (FileTreeWalk.access$getStart$p(this$1).isFile()) {
        localArrayDeque.push(new SingleFileState(FileTreeWalk.access$getStart$p(this$1)));
      } else {
        done();
      }
    }
    ...
    private final FileTreeWalk.DirectoryState directoryState(File paramFile)
    {
      ...
      switch (WhenMappings.$EnumSwitchMapping$0[localFileWalkDirection.ordinal()])
      {
      default: 
    ...
    @Metadata(d1={"\000&\n\002\030\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\n\002\020\013\n\000\n\002\020\b\n\000\n\002\020\021\n\002\b\004\b\004\030\0002\0020\001B\r\022\006\020\002\032\0020\003¢\006\002\020\004J\n\020\r\032\004\030\0010\003H\026R\016\020\005\032\0020\006X\016¢\006\002\n\000R\016\020\007\032\0020\bX\016¢\006\002\n\000R\030\020\t\032\n\022\004\022\0020\003\030\0010\nX\016¢\006\004\n\002\020\013R\016\020\f\032\0020\006X\016¢\006\002\n\000¨\006\016"}, d2={"Lkotlin/io/FileTreeWalk$FileTreeWalkIterator$BottomUpDirectoryState;", "Lkotlin/io/FileTreeWalk$DirectoryState;", "rootDir", "Ljava/io/File;", "(Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;Ljava/io/File;)V", "failed", "", "fileIndex", "", "fileList", "", "[Ljava/io/File;", "rootVisited", "step", "kotlin-stdlib"}, k=1, mv={1, 7, 1}, xi=48)
      ...
      extends FileTreeWalk.DirectoryState
    {
      ...
      public File step()
      {
        ...
        if ((!this.failed) && (this.fileList == null))
        {
          ...
          {
            i = j;
            if (!((Boolean)((Function1)localObject).invoke(getRoot())).booleanValue()) {
              i = 1;
            }
          }
          if (i != 0) {
          ...
          if (localObject == null)
          {
            ...
            if (localObject != null) {
              ((Function2)localObject).invoke(getRoot(), new AccessDeniedException(getRoot(), null, "Cannot list files in a directory", 2, null));
            }
            this.failed = true;
          }
        }
        ...
        if (localObject != null) {
          ((Function1)localObject).invoke(getRoot());
        }
        return null;
      }
    }
    
    @Metadata(d1={"\000\032\n\002\030\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\n\002\020\013\n\002\b\002\b\004\030\0002\0020\001B\r\022\006\020\002\032\0020\003¢\006\002\020\004J\n\020\007\032\004\030\0010\003H\026R\016\020\005\032\0020\006X\016¢\006\002\n\000¨\006\b"}, d2={"Lkotlin/io/FileTreeWalk$FileTreeWalkIterator$SingleFileState;", "Lkotlin/io/FileTreeWalk$WalkState;", "rootFile", "Ljava/io/File;", "(Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;Ljava/io/File;)V", "visited", "", "step", "kotlin-stdlib"}, k=1, mv={1, 7, 1}, xi=48)
    ...
    @Metadata(d1={"\000(\n\002\030\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\n\002\020\b\n\000\n\002\020\021\n\002\b\002\n\002\020\013\n\002\b\002\b\004\030\0002\0020\001B\r\022\006\020\002\032\0020\003¢\006\002\020\004J\n\020\f\032\004\030\0010\003H\026R\016\020\005\032\0020\006X\016¢\006\002\n\000R\030\020\007\032\n\022\004\022\0020\003\030\0010\bX\016¢\006\004\n\002\020\tR\016\020\n\032\0020\013X\016¢\006\002\n\000¨\006\r"}, d2={"Lkotlin/io/FileTreeWalk$FileTreeWalkIterator$TopDownDirectoryState;", "Lkotlin/io/FileTreeWalk$DirectoryState;", "rootDir", "Ljava/io/File;", "(Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;Ljava/io/File;)V", "fileIndex", "", "fileList", "", "[Ljava/io/File;", "rootVisited", "", "step", "kotlin-stdlib"}, k=1, mv={1, 7, 1}, xi=48)
  ...
  @Metadata(d1={"\000\022\n\002\030\002\n\002\020\000\n\000\n\002\030\002\n\002\b\005\b\"\030\0002\0020\001B\r\022\006\020\002\032\0020\003¢\006\002\020\004J\n\020\007\032\004\030\0010\003H&R\021\020\002\032\0020\003¢\006\b\n\000\032\004\b\005\020\006¨\006\b"}, d2={"Lkotlin/io/FileTreeWalk$WalkState;", "", "root", "Ljava/io/File;", "(Ljava/io/File;)V", "getRoot", "()Ljava/io/File;", "step", "kotlin-stdlib"}, k=1, mv={1, 7, 1}, xi=48)
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/kotlin/io/FileTreeWalk.class
