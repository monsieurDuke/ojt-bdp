  ...
  extends Transition
{
  ...
  public Animator createAnimator(final ViewGroup paramViewGroup, final TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    ...
    {
      RectF localRectF2 = (RectF)paramTransitionValues1.values.get("materialContainerTransition:bounds");
      ...
      {
        RectF localRectF1 = (RectF)paramTransitionValues2.values.get("materialContainerTransition:bounds");
        ...
        if ((localRectF1 != null) && (localShapeAppearanceModel1 != null))
        {
          ...
          boolean bool = isEntering(localRectF2, localRectF1);
          if (!this.appliedThemeValues) {
            maybeApplyThemeValues(paramViewGroup.getContext(), bool);
          }
          paramViewGroup = new TransitionDrawable(getPathMotion(), localView1, localRectF2, localShapeAppearanceModel2, getElevationOrDefault(this.startElevation, localView1), localView2, localRectF1, localShapeAppearanceModel1, getElevationOrDefault(this.endElevation, localView2), this.containerColor, this.startContainerColor, this.endContainerColor, this.scrimColor, bool, this.elevationShadowEnabled, FadeModeEvaluators.get(this.fadeMode, bool), FitModeEvaluators.get(this.fitMode, bool, localRectF2, localRectF1), buildThresholdsGroup(bool), this.drawDebugEnabled, null);
    ...
    extends Drawable
  {
    ...
    private TransitionDrawable(PathMotion paramPathMotion, View paramView1, RectF paramRectF1, ShapeAppearanceModel paramShapeAppearanceModel1, float paramFloat1, View paramView2, RectF paramRectF2, ShapeAppearanceModel paramShapeAppearanceModel2, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, FadeModeEvaluator paramFadeModeEvaluator, FitModeEvaluator paramFitModeEvaluator, MaterialContainerTransform.ProgressThresholdsGroup paramProgressThresholdsGroup, boolean paramBoolean3)
    {
      ...
      this.startContainerPaint = localPaint3;
      Paint localPaint4 = new Paint();
      this.endContainerPaint = localPaint4;
      this.shadowPaint = new Paint();
      Paint localPaint1 = new Paint();
      this.scrimPaint = localPaint1;
      ...
      localPaint4.setColor(paramInt3);
      ...
      localPaint1.setShader(TransitionUtils.createColorShader(paramInt4));
      localPaint2.setStyle(Paint.Style.STROKE);
      localPaint2.setStrokeWidth(10.0F);
      updateProgress(0.0F);
    }
    ...
    private void updateProgress(float paramFloat)
    {
      ...
      this.currentStartBounds.set(f1 - ((FitModeResult)localObject).currentStartWidth / 2.0F, f2, this.fitModeResult.currentStartWidth / 2.0F + f1, this.fitModeResult.currentStartHeight + f2);
      ...
      float f1 = ((Float)Preconditions.checkNotNull(Float.valueOf(MaterialContainerTransform.ProgressThresholdsGroup.access$600(this.progressThresholds).start))).floatValue();
      float f2 = ((Float)Preconditions.checkNotNull(Float.valueOf(MaterialContainerTransform.ProgressThresholdsGroup.access$600(this.progressThresholds).end))).floatValue();
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/com/google/android/material/transition/MaterialContainerTransform.class
