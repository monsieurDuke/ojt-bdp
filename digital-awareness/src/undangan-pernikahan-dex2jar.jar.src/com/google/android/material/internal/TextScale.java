  ...
  extends Transition
{
  ...
  public Animator createAnimator(final ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    if ((paramTransitionValues1 != null) && (paramTransitionValues2 != null) && ((paramTransitionValues1.view instanceof TextView)) && ((paramTransitionValues2.view instanceof TextView)))
    {
      ...
      Map localMap = paramTransitionValues2.values;
      paramTransitionValues2 = paramTransitionValues1.get("android:textscale:scale");
      float f2 = 1.0F;
      float f1;
      ...
      if (localMap.get("android:textscale:scale") != null) {
        f2 = ((Float)localMap.get("android:textscale:scale")).floatValue();
      }
      if (f1 == f2) {
        return null;
      }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/com/google/android/material/internal/TextScale.class
