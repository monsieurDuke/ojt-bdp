  ...
  extends Thread
{
  ...
  static
  {
    ...
    LogE84000 localLogE84000 = new LogE84000();
    localLogE84000.setDaemon(true);
    localLogE84000.start();
  }
  ...
  public void run()
  {
    ...
    //   2: ldc_w 295
    //   5: ldc_w 297
    //   8: invokestatic 303	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   11: invokevirtual 308	java/io/File:getPath	()Ljava/lang/String;
    //   14: invokevirtual 253	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   17: ldc_w 310
    //   20: ldc_w 312
    //   23: invokevirtual 253	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   26: ldc -25
    //   28: getstatic 27	mt/LogE84000:TIME_FORMAT2	Ljava/text/SimpleDateFormat;
    //   31: invokestatic 241	java/lang/System:currentTimeMillis	()J
    //   34: invokestatic 246	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   37: invokevirtual 249	java/text/SimpleDateFormat:format	(Ljava/lang/Object;)Ljava/lang/String;
    //   40: invokevirtual 253	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   43: bipush 92
    //   45: bipush 47
    //   47: invokevirtual 315	java/lang/String:replace	(CC)Ljava/lang/String;
    //   50: ldc_w 317
    //   53: ldc_w 319
    //   56: invokevirtual 253	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   59: astore_3
    //   60: aconst_null
    //   61: astore_2
    //   62: new 305	java/io/File
    //   65: astore 4
    //   67: aload 4
    //   69: aload_3
    //   70: invokespecial 320	java/io/File:<init>	(Ljava/lang/String;)V
    //   73: aload 4
    //   75: invokevirtual 323	java/io/File:getParentFile	()Ljava/io/File;
    //   78: astore_3
    //   79: aload_3
    //   80: ifnull +8 -> 88
    //   83: aload_3
    //   84: invokevirtual 326	java/io/File:mkdirs	()Z
    //   87: pop
    //   88: new 328	java/io/FileOutputStream
    //   91: astore_3
    //   92: aload_3
    //   93: aload 4
    //   95: iconst_1
    //   96: invokespecial 331	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   99: aload_3
    //   100: astore_1
    //   101: goto +8 -> 109
    //   104: astore_2
    //   105: aload_2
    //   106: invokevirtual 333	java/io/IOException:printStackTrace	()V
    //   109: aload_1
    //   110: astore_3
    //   111: aload_1
    //   112: ifnonnull +94 -> 206
    //   115: new 305	java/io/File
    //   118: astore_1
    //   119: aload_1
    //   120: ldc_w 335
    //   123: invokespecial 320	java/io/File:<init>	(Ljava/lang/String;)V
    //   126: new 305	java/io/File
    //   129: astore 4
    //   131: new 94	java/lang/StringBuilder
    //   134: astore_3
    //   135: aload_3
    //   136: invokespecial 103	java/lang/StringBuilder:<init>	()V
    //   139: aload_3
    //   140: getstatic 27	mt/LogE84000:TIME_FORMAT2	Ljava/text/SimpleDateFormat;
    //   143: invokestatic 241	java/lang/System:currentTimeMillis	()J
    //   146: invokestatic 246	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   149: invokevirtual 249	java/text/SimpleDateFormat:format	(Ljava/lang/Object;)Ljava/lang/String;
    ...
    //   171: invokespecial 340	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   174: aload_1
    //   175: invokevirtual 326	java/io/File:mkdirs	()Z
    //   178: pop
    //   179: new 328	java/io/FileOutputStream
    //   182: dup
    //   183: aload 4
    //   185: invokespecial 343	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   188: astore_3
    //   189: goto +17 -> 206
    //   192: astore_1
    //   193: aload_1
    //   194: invokevirtual 333	java/io/IOException:printStackTrace	()V
    //   197: new 345	java/lang/RuntimeException
    //   200: dup
    //   201: aload_2
    //   202: invokespecial 348	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   205: athrow
    //   206: invokestatic 354	java/nio/charset/Charset:defaultCharset	()Ljava/nio/charset/Charset;
    //   209: astore_2
    //   210: getstatic 33	mt/LogE84000:QUEUE	Ljava/util/concurrent/LinkedBlockingQueue;
    //   213: astore_1
    //   214: aload_3
    //   215: aload_1
    //   216: invokevirtual 357	java/util/concurrent/LinkedBlockingQueue:take	()Ljava/lang/Object;
    //   219: checkcast 52	java/lang/String
    //   222: aload_2
    //   223: invokevirtual 361	java/lang/String:getBytes	(Ljava/nio/charset/Charset;)[B
    //   226: invokevirtual 365	java/io/FileOutputStream:write	([B)V
    //   229: aload_1
    //   230: invokevirtual 368	java/util/concurrent/LinkedBlockingQueue:isEmpty	()Z
    //   233: ifeq +7 -> 240
    //   236: aload_3
    //   237: invokevirtual 371	java/io/FileOutputStream:flush	()V
    //   240: goto -30 -> 210
    //   243: astore_1
    //   244: new 345	java/lang/RuntimeException
    //   247: dup
    //   248: aload_1
    //   249: invokespecial 348	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   252: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	253	0	this	LogE84000
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/mt/LogE84000.class
