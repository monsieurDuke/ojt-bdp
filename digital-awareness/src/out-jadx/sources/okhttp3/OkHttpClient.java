...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m1703addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m1704addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            ...
            if ((!Intrinsics.areEqual(certificatePinner, builder.certificatePinner)) != false) {
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> connectionSpecs) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(connectionSpecs, builder.connectionSpecs)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder dns(Dns dns) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(dns, builder.dns)) != false) {
                builder.routeDatabase = null;
            }
            builder.dns = dns;
            return this;
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(hostnameVerifier, builder.hostnameVerifier)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder protocols(List<? extends Protocol> protocols) {
            ...
            if ((!mutableList.contains(Protocol.HTTP_1_0)) != true) {
                throw new IllegalArgumentException(("protocols must not contain http/1.0: " + mutableList).toString());
            }
            if (mutableList == null) {
                throw new NullPointerException("null cannot be cast to non-null type kotlin.collections.List<okhttp3.Protocol?>");
            }
            if ((!mutableList.contains(null)) != true) {
                throw new IllegalArgumentException("protocols must not contain null".toString());
            }
            mutableList.remove(Protocol.SPDY_3);
            if ((!Intrinsics.areEqual(mutableList, builder.protocols)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder proxy(Proxy proxy) {
            Builder builder = this;
            if ((!Intrinsics.areEqual(proxy, builder.proxy)) != false) {
                builder.routeDatabase = null;
            }
            builder.proxy = proxy;
            return this;
        ...
        public final Builder proxyAuthenticator(Authenticator proxyAuthenticator) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(proxyAuthenticator, builder.proxyAuthenticator)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(proxySelector, builder.proxySelector)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if ((!Intrinsics.areEqual(socketFactory, builder.socketFactory)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(sslSocketFactory, builder.sslSocketFactoryOrNull)) != false) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
            ...
            Builder builder = this;
            if ((!Intrinsics.areEqual(sslSocketFactory, builder.sslSocketFactoryOrNull)) != false || (!Intrinsics.areEqual(trustManager, builder.x509TrustManagerOrNull)) != false) {
                builder.routeDatabase = null;
            }
            builder.sslSocketFactoryOrNull = sslSocketFactory;
    ...
    public final List<Interceptor> m1691deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m1692deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final List<Protocol> m1694deprecated_protocols() {
        return this.protocols;
    }
    ...
    public final SSLSocketFactory m1701deprecated_sslSocketFactory() {
