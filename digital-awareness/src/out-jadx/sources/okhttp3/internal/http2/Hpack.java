        ...
        public final void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (num != null && 2 <= (i4 = num.intValue() + 1) && 7 >= i4) {
                    if (Intrinsics.areEqual(Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i4 - 1].value, byteString)) {
                        i3 = i4;
                    } else if (Intrinsics.areEqual(Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i4].value, byteString)) {
                        i3 = i4 + 1;
                    }
                }
                if (i3 == -1) {
                ...
                } else if (asciiLowercase.startsWith(Header.PSEUDO_PREFIX) && (!Intrinsics.areEqual(Header.TARGET_AUTHORITY, asciiLowercase)) == true) {
                    writeInt(i4, 15, 0);
                    writeByteString(byteString);
                } else {
                    writeInt(i4, 63, 64);
