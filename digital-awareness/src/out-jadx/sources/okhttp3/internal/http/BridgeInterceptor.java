...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (request.header("Host") == null) {
            String hostHeader$default = Util.toHostHeader$default(request.url(), false, 1, null);
            Log5ECF72.a(hostHeader$default);
            LogE84000.a(hostHeader$default);
            Log229316.a(hostHeader$default);
        ...
        if (z) {
            ...
            if (StringsKt.equals("gzip", header$default, true) && HttpHeaders.promisesBody(proceed) && (body = proceed.body()) != null) {
                ...
                request2.body(new RealResponseBody(header$default2, -1L, Okio.buffer(gzipSource)));
            }
        }
