...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final List<String> getSubjectAltNames(X509Certificate certificate, int type) {
        ...
        try {
            ...
            for (List<?> list : subjectAlternativeNames) {
                if (list != null && list.size() >= 2 && (!Intrinsics.areEqual(list.get(0), Integer.valueOf(type))) == false && (obj = list.get(1)) != null) {
                    if (obj == null) {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        ...
        if (!StringsKt.startsWith$default(lowerCase, "*.", false, 2, (Object) null) || StringsKt.indexOf$default((CharSequence) lowerCase, '*', 1, false, 4, (Object) null) != -1 || str.length() < lowerCase.length() || Intrinsics.areEqual("*.", lowerCase)) {
            return false;
        }
        if (lowerCase == null) {
            throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
    ...
    private final boolean verifyIpAddress(String ipAddress, X509Certificate certificate) {
        ...
        Iterator<T> it = subjectAltNames.iterator();
        while (it.hasNext()) {
            String canonicalHost2 = HostnamesKt.toCanonicalHost((String) it.next());
            Log5ECF72.a(canonicalHost2);
            LogE84000.a(canonicalHost2);
            Log229316.a(canonicalHost2);
            if (Intrinsics.areEqual(canonicalHost, canonicalHost2)) {
                return true;
            }
        }
        return false;
