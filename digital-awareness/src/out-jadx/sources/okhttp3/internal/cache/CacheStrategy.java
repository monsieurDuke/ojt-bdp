...
public final class CacheStrategy {
        ...
        public final boolean isCacheable(Response response, Request request) {
            ...
            switch (response.code()) {
                ...
                case 307:
                    ...
                    if (header$default == null && response.cacheControl().maxAgeSeconds() == -1 && !response.cacheControl().getIsPublic() && !response.cacheControl().getIsPrivate()) {
                        return false;
                    }
                    break;
                default:
    ...
    public static final class Factory {
        ...
        private final long cacheResponseAge() {
            ...
            long max2 = this.ageSeconds != -1 ? Math.max(max, TimeUnit.SECONDS.toMillis(this.ageSeconds)) : max;
            long j = this.receivedResponseMillis;
            return max2 + (j - this.sentRequestMillis) + (this.nowMillis - j);
        }
        ...
        private final CacheStrategy computeCandidate() {
            ...
            if ((!this.request.isHttps() || this.cacheResponse.handshake() != null) && CacheStrategy.INSTANCE.isCacheable(this.cacheResponse, this.request)) {
                ...
                if (!cacheControl.noCache() && !hasConditions(this.request)) {
                    ...
                    if (!cacheControl2.noCache() && cacheResponseAge + millis < computeFreshnessLifetime + j) {
                        Response.Builder newBuilder = this.cacheResponse.newBuilder();
                        if (cacheResponseAge + millis >= computeFreshnessLifetime) {
