...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final class Editor {
        ...
        public final Sink newSink(final int index) {
            synchronized (this.this$0) {
                ...
                if ((!Intrinsics.areEqual(this.entry.getCurrentEditor(), this)) == true) {
        ...
        public final Source newSource(int index) {
            synchronized (this.this$0) {
                ...
                Source source = null;
                if (!this.entry.getReadable() || (!Intrinsics.areEqual(this.entry.getCurrentEditor(), this)) == true || this.entry.getZombie()) {
                    return null;
                }
                try {
    ...
    public final class Entry {
        ...
        public Entry(DiskLruCache this$0, String key) {
            ...
            for (int i = 0; i < valueCount; i++) {
                append.append(i);
                this.cleanFiles.add(new File(this$0.getDirectory(), append.toString()));
                append.append(".tmp");
                this.dirtyFiles.add(new File(this$0.getDirectory(), append.toString()));
            ...
            return new ForwardingSource(source) { // from class: okhttp3.internal.cache.DiskLruCache$Entry$newSource$1
                ...
                public void close() {
                    ...
                    synchronized (DiskLruCache.Entry.this.this$0) {
                        DiskLruCache.Entry.this.setLockingSourceCount$okhttp(r2.getLockingSourceCount() - 1);
    ...
    private final void readJournal() throws IOException {
        ...
        try {
            ...
            if ((!Intrinsics.areEqual(MAGIC, readUtf8LineStrict)) == false && (!Intrinsics.areEqual(VERSION_1, readUtf8LineStrict2)) == false) {
                String valueOf = String.valueOf(this.appVersion);
                Log5ECF72.a(valueOf);
                LogE84000.a(valueOf);
                Log229316.a(valueOf);
                if ((!Intrinsics.areEqual(valueOf, readUtf8LineStrict3)) == false) {
                    String valueOf2 = String.valueOf(this.valueCount);
                    Log5ECF72.a(valueOf2);
                    LogE84000.a(valueOf2);
                    Log229316.a(valueOf2);
                    if ((!Intrinsics.areEqual(valueOf2, readUtf8LineStrict4)) == false) {
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        if (indexOf$default2 != -1) {
            ...
            if (indexOf$default == str3.length() && StringsKt.startsWith$default(line, str3, false, 2, (Object) null)) {
                ...
                String substring3 = line.substring(i2);
                Intrinsics.checkNotNullExpressionValue(substring3, "(this as java.lang.String).substring(startIndex)");
                List<String> split$default = StringsKt.split$default((CharSequence) substring3, new char[]{' '}, false, 0, 6, (Object) null);
