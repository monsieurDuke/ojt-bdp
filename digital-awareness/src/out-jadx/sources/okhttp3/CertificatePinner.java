    ...
    public static final class Pin {
        ...
        public final boolean matchesHostname(String hostname) {
            ...
            if (!StringsKt.startsWith$default(this.pattern, "**.", false, 2, (Object) null)) {
                ...
                return StringsKt.regionMatches$default(hostname, hostname.length() - length, this.pattern, 1, length, false, 16, (Object) null) && StringsKt.lastIndexOf$default((CharSequence) hostname, '.', (hostname.length() - length) + (-1), false, 4, (Object) null) == -1;
            }
            int length2 = this.pattern.length() - 3;
            int length3 = hostname.length() - length2;
            if (StringsKt.regionMatches$default(hostname, hostname.length() - length2, this.pattern, 3, length2, false, 16, (Object) null)) {
                return length3 == 0 || hostname.charAt(length3 + (-1)) == '.';
            }
            return false;
        }
