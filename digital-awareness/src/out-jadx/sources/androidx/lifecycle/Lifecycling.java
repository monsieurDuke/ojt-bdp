...
public class Lifecycling {
    ...
    private static Constructor<? extends GeneratedAdapter> generatedConstructor(Class<?> cls) {
        try {
            ...
            Log5ECF72.a(adapterName);
            LogE84000.a(adapterName);
            Log229316.a(adapterName);
    ...
    public static LifecycleEventObserver lifecycleEventObserver(Object object) {
        ...
        if (list.size() == 1) {
            return new SingleGeneratedAdapterObserver(createGeneratedAdapter(list.get(0), object));
        }
        GeneratedAdapter[] generatedAdapterArr = new GeneratedAdapter[list.size()];
        for (int i = 0; i < list.size(); i++) {
            generatedAdapterArr[i] = createGeneratedAdapter(list.get(i), object);
        }
