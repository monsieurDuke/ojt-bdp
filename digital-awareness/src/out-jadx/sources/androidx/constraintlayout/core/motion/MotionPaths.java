...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void applyParameters(MotionWidget c) {
        ...
        for (String str : c.getCustomAttributeNames()) {
            CustomVariable customAttribute = c.getCustomAttribute(str);
    ...
    public void getCenter(double p, int[] toUse, double[] data, float[] point, int offset) {
        ...
        if (motion != null) {
            ...
            motion.getCenter(p, fArr, new float[2]);
            float f7 = fArr[0];
            float f8 = fArr[1];
            float f9 = f2;
            float f10 = f3;
        ...
        while (true) {
            ...
            if (i3 >= dArr.length) {
                ...
                if (motion != null) {
                    ...
                    float[] fArr2 = new float[2];
                    float f21 = f18;
                    motion.getCenter(position, fArr, fArr2);
                    float f22 = fArr[0];
                    float f23 = fArr[1];
                    float f24 = f;
                    float f25 = f12;
                    ...
                    float f28 = fArr2[1];
                    float f29 = f17;
                    float sin = (float) ((f22 + (f24 * Math.sin(f21))) - (f19 / 2.0f));
                    float cos = (float) ((f23 - (f24 * Math.cos(f21))) - (f11 / 2.0f));
                    double d = f25;
                    f2 = f19;
                    f3 = f11;
                    float sin2 = (float) (f27 + (d * Math.sin(f21)) + (f24 * Math.cos(f21) * f26));
                    float cos2 = (float) ((f28 - (f25 * Math.cos(f21))) + (f24 * Math.sin(f21) * f26));
                    f = sin;
                    if (slope.length >= 2) {
                        slope[0] = sin2;
                        slope[1] = cos2;
                    ...
                    if (Float.isNaN(f29)) {
                        ...
                        double d2 = f29;
                        f5 = cos2;
                        float degrees = (float) (d2 + Math.toDegrees(Math.atan2(cos2, sin2)));
                        motionWidget = view;
                        motionWidget.setRotationZ(degrees);
                    }
                    f4 = cos;
                } else {
                    float f30 = f18;
                    ...
                    float f32 = f13;
                    if (!Float.isNaN(f17)) {
                        motionWidget.setRotationZ((float) (0.0f + f17 + Math.toDegrees(Math.atan2(f32 + (f20 / 2.0f), f31 + (f14 / 2.0f)))));
                    }
                    f4 = f30;
                }
                int i4 = (int) (f + 0.5f);
            ...
            double d3 = cycle != null ? cycle[i3] : 0.0d;
            if (!Double.isNaN(this.mTempValue[i3])) {
                d3 = this.mTempValue[i3] + d3;
            }
            float f33 = (float) d3;
            f6 = f15;
            f7 = f16;
