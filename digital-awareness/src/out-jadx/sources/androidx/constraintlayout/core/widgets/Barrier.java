...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        int i8 = !z && (((i = this.mBarrierType) == 0 && z2) || ((i == 2 && z3) || ((i == 1 && z2) || (i == 3 && z3)))) ? 5 : 4;
        for (int i9 = 0; i9 < this.mWidgetsCount; i9++) {
            ConstraintWidget constraintWidget2 = this.mWidgets[i9];
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                SolverVariable createObjectVariable = system.createObjectVariable(constraintWidget2.mListAnchors[this.mBarrierType]);
                ...
                if (i11 == 0 || i11 == 2) {
                    system.addLowerBarrier(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin - i10, z);
                } else {
                    system.addGreaterBarrier(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin + i10, z);
                }
                system.addEquality(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin + i10, i8);
            }
        }
