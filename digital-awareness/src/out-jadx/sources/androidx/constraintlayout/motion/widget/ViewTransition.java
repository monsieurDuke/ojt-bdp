...
public class ViewTransition {
                    ...
                    case 2:
                        ...
                        switch (c) {
                            ...
                            default:
                                ...
                                LogE84000.a(loc);
                                Log229316.a(loc);
                                Log.e(str, sb.append(loc).append(" unknown tag ").append(name).toString());
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
            ...
            while (i3 < constraintSetIds.length) {
                ...
                if (i4 != fromId) {
                    ...
                    for (int i5 = i2; i5 < length; i5++) {
                        ConstraintSet.Constraint constraint = constraintSet.getConstraint(views[i5].getId());
        ...
        for (View view2 : views) {
            updateTransition(transition, view2);
        }
