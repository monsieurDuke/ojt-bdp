...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void warmth(float warmth) {
            ...
            float log2;
            float f2;
            float f3 = (5000.0f / (warmth <= 0.0f ? 0.01f : warmth)) / 100.0f;
            if (f3 > 66.0f) {
                float f4 = f3 - 60.0f;
                f = ((float) Math.pow(f4, -0.13320475816726685d)) * 329.69873f;
                log = ((float) Math.pow(f4, 0.07551484555006027d)) * 288.12216f;
            } else {
                log = (((float) Math.log(f3)) * 99.4708f) - 161.11957f;
                f = 255.0f;
            }
            float log3 = f3 < 66.0f ? f3 > 19.0f ? (((float) Math.log(f3 - 10.0f)) * 138.51773f) - 305.0448f : 0.0f : 255.0f;
            float min = Math.min(255.0f, Math.max(f, 0.0f));
            float min2 = Math.min(255.0f, Math.max(log, 0.0f));
            float min3 = Math.min(255.0f, Math.max(log3, 0.0f));
            float f5 = 5000.0f / 100.0f;
            if (f5 > 66.0f) {
                float f6 = f5 - 60.0f;
                f2 = ((float) Math.pow(f6, -0.13320475816726685d)) * 329.69873f;
                log2 = ((float) Math.pow(f6, 0.07551484555006027d)) * 288.12216f;
            } else {
                log2 = (((float) Math.log(f5)) * 99.4708f) - 161.11957f;
                f2 = 255.0f;
            }
            float log4 = f5 < 66.0f ? f5 > 19.0f ? (((float) Math.log(f5 - 10.0f)) * 138.51773f) - 305.0448f : 0.0f : 255.0f;
            float min4 = Math.min(255.0f, Math.max(f2, 0.0f));
    ...
    private void setMatrix() {
        ...
        float f5 = (intrinsicWidth * height < intrinsicHeight * width ? width / intrinsicWidth : height / intrinsicHeight) * f3;
        matrix.postScale(f5, f5);
        matrix.postTranslate(((((width - (f5 * intrinsicWidth)) * f) + width) - (f5 * intrinsicWidth)) * 0.5f, ((((height - (f5 * intrinsicHeight)) * f2) + height) - (f5 * intrinsicHeight)) * 0.5f);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    ViewOutlineProvider viewOutlineProvider = new ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.ImageFilterView.1
                        @Override // android.view.ViewOutlineProvider
                        public void getOutline(View view, Outline outline) {
                            outline.setRoundRect(0, 0, ImageFilterView.this.getWidth(), ImageFilterView.this.getHeight(), (Math.min(r0, r7) * ImageFilterView.this.mRoundPercent) / 2.0f);
                        }
                    };
                    this.mViewOutlineProvider = viewOutlineProvider;
                    setOutlineProvider(viewOutlineProvider);
