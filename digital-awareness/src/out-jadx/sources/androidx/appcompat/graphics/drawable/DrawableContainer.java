...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        final boolean setLayoutDirection(int layoutDirection, int currentIndex) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                if (drawableArr[i2] != null) {
                    boolean layoutDirection2 = Build.VERSION.SDK_INT >= 23 ? DrawableCompat.setLayoutDirection(drawableArr[i2], layoutDirection) : false;
                    if (i2 == currentIndex) {
                        z = layoutDirection2;
                    }
                }
    ...
    public boolean getPadding(Rect padding) {
        ...
        if (constantPadding != null) {
            ...
            padding2 = (((constantPadding.left | constantPadding.top) | constantPadding.bottom) | constantPadding.right) != 0 ? DEFAULT_DITHER : false;
        } else {
            Drawable drawable = this.mCurrDrawable;
            padding2 = drawable != null ? drawable.getPadding(padding) : super.getPadding(padding);
        }
        if (needsMirroring()) {
            int i = padding.left;
