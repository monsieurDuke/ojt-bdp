...
public class AccessibilityNodeInfoCompat {
    ...
    private int idForClickableSpan(ClickableSpan span, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        if (sparseArray != null) {
            for (int i = 0; i < sparseArray.size(); i++) {
                if (span.equals(sparseArray.valueAt(i).get())) {
    ...
    private void setBooleanProperty(int property, boolean value) {
        Bundle extras = getExtras();
        if (extras != null) {
            extras.putInt(BOOLEAN_PROPERTY_KEY, (value ? property : 0) | (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~property)));
        }
    }
    ...
    public String toString() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            for (int i = 0; i < actionList.size(); i++) {
                ...
                Log5ECF72.a(actionSymbolicName);
                LogE84000.a(actionSymbolicName);
                Log229316.a(actionSymbolicName);
            ...
            while (actions != 0) {
                ...
                Log5ECF72.a(actionSymbolicName2);
                LogE84000.a(actionSymbolicName2);
                Log229316.a(actionSymbolicName2);
