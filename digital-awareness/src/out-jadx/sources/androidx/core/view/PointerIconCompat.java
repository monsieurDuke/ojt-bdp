...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat create(Bitmap bitmap, float hotSpotX, float hotSpotY) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.create(bitmap, hotSpotX, hotSpotY)) : new PointerIconCompat(null);
    }

    public static PointerIconCompat getSystemIcon(Context context, int style) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.getSystemIcon(context, style)) : new PointerIconCompat(null);
    }

    public static PointerIconCompat load(Resources resources, int resourceId) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.load(resources, resourceId)) : new PointerIconCompat(null);
    }
