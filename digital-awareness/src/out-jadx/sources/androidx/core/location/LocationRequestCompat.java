        ...
        public static Object toLocationRequest(LocationRequestCompat obj, String provider) {
            if (Build.VERSION.SDK_INT >= 19) {
                try {
                    ...
                    Object invoke = sCreateFromDeprecatedProviderMethod.invoke(null, provider, Long.valueOf(obj.getIntervalMillis()), Float.valueOf(obj.getMinUpdateDistanceMeters()), false);
                    if (invoke == null) {
                        return null;
                    }
                    ...
                    sSetQualityMethod.invoke(invoke, Integer.valueOf(obj.getQuality()));
                    ...
                    sSetFastestIntervalMethod.invoke(invoke, Long.valueOf(obj.getMinUpdateIntervalMillis()));
                    if (obj.getMaxUpdates() < Integer.MAX_VALUE) {
                        ...
                        sSetNumUpdatesMethod.invoke(invoke, Integer.valueOf(obj.getMaxUpdates()));
                    }
                    if (obj.getDurationMillis() < Long.MAX_VALUE) {
                        ...
                        sSetExpireInMethod.invoke(invoke, Long.valueOf(obj.getDurationMillis()));
                    }
                    return invoke;
