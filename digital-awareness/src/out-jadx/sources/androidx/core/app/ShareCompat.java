...
public final class ShareCompat {
    ...
    public static class Api16Impl {
        ...
        static String escapeHtml(CharSequence charSequence) {
            ...
            Log5ECF72.a(escapeHtml);
            LogE84000.a(escapeHtml);
            Log229316.a(escapeHtml);
            return escapeHtml;
        }
    ...
    public static class IntentReader {
        ...
        public IntentReader(Context context, Intent intent) {
            ...
            Log5ECF72.a(callingPackage);
            LogE84000.a(callingPackage);
            Log229316.a(callingPackage);
        ...
        private static void withinStyle(StringBuilder out, CharSequence text, int start, int end) {
            ...
            while (i < end) {
                ...
                if (charAt == '<') {
                    ...
                    out.append("&#").append((int) charAt).append(";");
                } else if (charAt == ' ') {
    ...
    public static String getCallingPackage(Activity activity) {
        ...
        Log5ECF72.a(callingPackage2);
        LogE84000.a(callingPackage2);
        Log229316.a(callingPackage2);
