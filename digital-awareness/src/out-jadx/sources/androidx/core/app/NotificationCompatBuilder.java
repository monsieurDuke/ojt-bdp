...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            List combineLists2 = Build.VERSION.SDK_INT < 28 ? combineLists(getPeople(builder.mPersonList), builder.mPeople) : builder.mPeople;
            ...
            if (builder.mInvisibleActions.size() > 0) {
                ...
                for (int i = 0; i < builder.mInvisibleActions.size(); i++) {
                    ...
                    LogE84000.a(num);
                    Log229316.a(num);
                    bundle3.putBundle(num, NotificationCompatJellybean.getBundleForAction(builder.mInvisibleActions.get(i)));
                }
