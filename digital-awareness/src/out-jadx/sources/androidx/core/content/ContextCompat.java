...
public class ContextCompat {
    ...
    public static String getAttributionTag(Context context) {
        ...
        Log5ECF72.a(attributionTag);
        LogE84000.a(attributionTag);
        Log229316.a(attributionTag);
    ...
    public static <T> T getSystemService(Context context, Class<T> cls) {
        ...
        Log5ECF72.a(systemServiceName);
        LogE84000.a(systemServiceName);
        Log229316.a(systemServiceName);
