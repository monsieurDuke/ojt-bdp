...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            if (layoutState.mLayoutDirection == r10) {
                decoratedMeasurement = layoutParams.mFullSpan ? getMaxEnd(endAfterPadding) : span.getEndLine(endAfterPadding);
                ...
                minStart = layoutParams.mFullSpan ? getMinStart(endAfterPadding) : span.getStartLine(endAfterPadding);
            ...
            if (isLayoutRTL() && this.mOrientation == r10) {
                int endAfterPadding2 = layoutParams.mFullSpan ? this.mSecondaryOrientation.getEndAfterPadding() : this.mSecondaryOrientation.getEndAfterPadding() - (((this.mSpanCount - r10) - span.mIndex) * this.mSizePerSpan);
            ...
            if (this.mOrientation == r10) {
                span2 = span;
                layoutDecoratedWithMargins(next, i2, i4, decoratedMeasurement2, i5);
            } else {
                span2 = span;
                layoutDecoratedWithMargins(next, i4, i2, i5, decoratedMeasurement2);
            }
        ...
        return startAfterPadding2 > 0 ? Math.min(layoutState.mAvailable, startAfterPadding2) : i;
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
        ...
        if (this.mOrientation == 0) {
            info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, -1, -1, false, false));
        } else {
            info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, false, false));
        }
    }
    ...
    public void setMeasuredDimension(Rect childrenBounds, int wSpec, int hSpec) {
        ...
        if (this.mOrientation == 1) {
            chooseSize2 = chooseSize(hSpec, childrenBounds.height() + paddingTop, getMinimumHeight());
            chooseSize = chooseSize(wSpec, (this.mSizePerSpan * this.mSpanCount) + paddingLeft, getMinimumWidth());
        } else {
            chooseSize = chooseSize(wSpec, childrenBounds.width() + paddingLeft, getMinimumWidth());
            chooseSize2 = chooseSize(hSpec, (this.mSizePerSpan * this.mSpanCount) + paddingTop, getMinimumHeight());
        }
