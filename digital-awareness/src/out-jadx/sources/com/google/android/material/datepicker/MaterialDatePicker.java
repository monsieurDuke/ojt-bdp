...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                ...
                view2.setPadding(view2.getPaddingLeft(), paddingTop + i2, findViewById.getPaddingRight(), findViewById.getPaddingBottom());
                return insets;
            }
        });
    ...
    public void updateHeader() {
        ...
        String format = String.format(getString(R.string.mtrl_picker_announce_current_selection), headerText);
        Log5ECF72.a(format);
        LogE84000.a(format);
        Log229316.a(format);
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, R.attr.MT_Bin, MaterialDatePicker.class.getCanonicalName());
