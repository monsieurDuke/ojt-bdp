...
public class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        materialShapeDrawable2.setStroke(this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, R.attr.MT_Bin) : 0);
        if (IS_MIN_LOLLIPOP) {
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                surfaceColorStrokeDrawable.setStroke(this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, R.attr.MT_Bin) : 0);
            }
        }
    }
