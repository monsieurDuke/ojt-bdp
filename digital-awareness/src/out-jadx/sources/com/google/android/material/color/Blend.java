...
public final class Blend {
    ...
    public static int harmonize(int designColor, int sourceColor) {
        ...
        return Hct.from(MathUtils.sanitizeDegrees(fromInt.getHue() + (rotationDirection(fromInt.getHue(), fromInt2.getHue()) * Math.min(0.5f * MathUtils.differenceDegrees(fromInt.getHue(), fromInt2.getHue()), (float) HARMONIZE_MAX_DEGREES))), fromInt.getChroma(), fromInt.getTone()).toInt();
    }
