...
class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(View view, float elevation) {
        ...
        stateListAnimator.addState(new int[]{16842910, R.attr.state_liftable, -R.attr.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(integer));
        stateListAnimator.addState(new int[]{16842910}, ObjectAnimator.ofFloat(view, "elevation", elevation).setDuration(integer));
