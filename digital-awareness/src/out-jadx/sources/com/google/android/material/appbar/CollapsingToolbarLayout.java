...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                switch (layoutParams.collapseMode) {
                    case 1:
                        ...
                        break;
                    case 2:
                        viewOffsetHelper.setTopAndBottomOffset(Math.round((-verticalOffset) * layoutParams.parallaxMult));
                        break;
                }
            }
            ...
            CollapsingToolbarLayout.this.collapsingTextHelper.setFadeModeStartFraction(Math.min(1.0f, (r1 - CollapsingToolbarLayout.this.getScrimVisibleHeightTrigger()) / height));
            CollapsingToolbarLayout.this.collapsingTextHelper.setCurrentOffsetY(CollapsingToolbarLayout.this.currentOffset + height);
            CollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction(Math.abs(verticalOffset) / height);
        }
    }
    ...
    */
    ...
    private View findDirectChild(View descendant) {
        ...
        for (ViewParent parent = descendant.getParent(); parent != this && parent != null; parent = parent.getParent()) {
    ...
    private void updateCollapsedBounds(boolean isRtl) {
        ...
        this.collapsingTextHelper.setCollapsedBounds(this.tmpRect.left + (isRtl ? i2 : i), this.tmpRect.top + maxOffsetForPinChild + i3, this.tmpRect.right - (isRtl ? i : i2), (this.tmpRect.bottom + maxOffsetForPinChild) - i4);
    }
    ...
    private void updateContentScrimBounds(Drawable contentScrim, View toolbar, int width, int height) {
        contentScrim.setBounds(0, 0, width, (isTitleCollapseFadeMode() && toolbar != null && this.collapsingTitleEnabled) ? toolbar.getBottom() : height);
    }
    ...
    private void updateTextBounds(int left, int top, int right, int bottom, boolean forceRecalculate) {
        ...
        if (z || forceRecalculate) {
            ...
            this.collapsingTextHelper.setExpandedBounds(z2 ? this.expandedMarginEnd : this.expandedMarginStart, this.tmpRect.top + this.expandedMarginTop, (right - left) - (z2 ? this.expandedMarginStart : this.expandedMarginEnd), (bottom - top) - this.expandedMarginBottom);
