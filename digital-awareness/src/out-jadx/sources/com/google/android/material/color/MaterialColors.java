...
public class MaterialColors {
    ...
    public static int layer(int backgroundColor, int overlayColor, float overlayAlpha) {
        return layer(backgroundColor, androidx.core.graphics.ColorUtils.setAlphaComponent(overlayColor, Math.round(Color.alpha(overlayColor) * overlayAlpha)));
    }
