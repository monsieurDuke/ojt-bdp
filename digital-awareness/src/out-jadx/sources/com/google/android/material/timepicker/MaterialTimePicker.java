...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int mode, TimePickerView timePickerView, ViewStub textInputStub) {
        if (mode != 0) {
            if (this.timePickerTextInputPresenter == null) {
                this.timePickerTextInputPresenter = new TimePickerTextInputPresenter((LinearLayout) textInputStub.inflate(), this.time);
            }
    ...
    public void updateInputMode(MaterialButton modeButton) {
        ...
        modeButton.setIconResource(((Integer) dataForMode.first).intValue());
        modeButton.setContentDescription(getResources().getString(((Integer) dataForMode.second).intValue()));
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, R.attr.MT_Bin, MaterialTimePicker.class.getCanonicalName());
