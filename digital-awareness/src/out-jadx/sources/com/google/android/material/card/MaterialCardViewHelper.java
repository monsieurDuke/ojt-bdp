...
public class MaterialCardViewHelper {
    ...
    private Drawable insetDrawable(Drawable originalDrawable) {
        ...
        return new InsetDrawable(originalDrawable, i2, i, i2, i) { // from class: com.google.android.material.card.MaterialCardViewHelper.1
    ...
    public void recalculateCheckedIconPosition(int measuredWidth, int measuredHeight) {
        if (this.clickableForegroundDrawable != null) {
            ...
            int i2 = 0;
            if ((Build.VERSION.SDK_INT < 21) || this.materialCardView.getUseCompatPadding()) {
                i = (int) Math.ceil(calculateVerticalBackgroundPadding() * 2.0f);
                i2 = (int) Math.ceil(calculateHorizontalBackgroundPadding() * 2.0f);
            }
