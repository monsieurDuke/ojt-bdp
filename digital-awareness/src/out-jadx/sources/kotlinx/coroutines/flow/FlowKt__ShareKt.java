...
public final /* synthetic */ class FlowKt__ShareKt {
    ...
    private static final <T> SharingConfig<T> configureSharing$FlowKt__ShareKt(Flow<? extends T> flow, int replay) {
        ...
        int coerceAtLeast = RangesKt.coerceAtLeast(replay, Channel.INSTANCE.getCHANNEL_DEFAULT_CAPACITY$kotlinx_coroutines_core()) - replay;
        ...
        return new SharingConfig<>(dropChannelOperators, i, ((ChannelFlow) flow).onBufferOverflow, ((ChannelFlow) flow).context);
    }
    ...
    private static final <T> Job launchSharing$FlowKt__ShareKt(CoroutineScope $this$launchSharing, CoroutineContext context, Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, SharingStarted started, T t) {
        return BuildersKt.launch($this$launchSharing, context, Intrinsics.areEqual(started, SharingStarted.INSTANCE.getEagerly()) ? CoroutineStart.DEFAULT : CoroutineStart.UNDISPATCHED, new FlowKt__ShareKt$launchSharing$1(started, flow, mutableSharedFlow, t, null));
    }
    ...
    public static final <T> SharedFlow<T> shareIn(Flow<? extends T> flow, CoroutineScope scope, SharingStarted started, int replay) {
        SharingConfig configureSharing$FlowKt__ShareKt = configureSharing$FlowKt__ShareKt(flow, replay);
    ...
    public static final <T> StateFlow<T> stateIn(Flow<? extends T> flow, CoroutineScope scope, SharingStarted started, T t) {
        ...
        return new ReadonlyStateFlow(MutableStateFlow, launchSharing$FlowKt__ShareKt(scope, configureSharing$FlowKt__ShareKt.context, configureSharing$FlowKt__ShareKt.upstream, MutableStateFlow, started, t));
    }
}
