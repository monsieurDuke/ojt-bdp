...
public final class CoroutineContextKt {
    ...
    private static final CoroutineContext foldCopies(CoroutineContext originalContext, CoroutineContext coroutineContext, final boolean isNewCoroutine) {
        ...
        boolean hasCopyableElements2 = hasCopyableElements(coroutineContext);
        if (!hasCopyableElements && !hasCopyableElements2) {
            return originalContext.plus(coroutineContext);
        }
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = coroutineContext;
        CoroutineContext coroutineContext2 = (CoroutineContext) originalContext.fold(EmptyCoroutineContext.INSTANCE, new Function2<CoroutineContext, CoroutineContext.Element, CoroutineContext>() { // from class: kotlinx.coroutines.CoroutineContextKt$foldCopies$folded$1
        ...
        return coroutineContext2.plus((CoroutineContext) objectRef.element);
    }
