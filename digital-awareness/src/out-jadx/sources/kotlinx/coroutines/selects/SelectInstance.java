        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    ...
                    Continuation<R> continuation = this.uCont;
                    Throwable m47exceptionOrNullimpl = Result.m47exceptionOrNullimpl(result);
                    Intrinsics.checkNotNull(m47exceptionOrNullimpl);
                    Result.Companion companion = Result.INSTANCE;
                    continuation.resumeWith(Result.m44constructorimpl(ResultKt.createFailure((DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(m47exceptionOrNullimpl, (CoroutineStackFrame) continuation) : m47exceptionOrNullimpl)));
                    return;
                }
            }
        }
