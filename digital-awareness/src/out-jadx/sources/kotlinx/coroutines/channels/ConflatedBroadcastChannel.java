...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    private final Closed offerInternal(E element) {
        ...
        while (true) {
            try {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(element, ((State) obj).subscribers))) {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, null, handler)) {
            Object obj = this._state;
            if ((obj instanceof Closed) && AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
        ...
        String stringPlus = Intrinsics.stringPlus("Another handler was already registered: ", obj2);
        Log5ECF72.a(stringPlus);
        LogE84000.a(stringPlus);
        Log229316.a(stringPlus);
    ...
    public Object mo1535trySendJP2dKIU(E element) {
        Closed offerInternal = offerInternal(element);
        return offerInternal == null ? ChannelResult.INSTANCE.m1555successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1553closedJP2dKIU(offerInternal.getSendException());
    }
}
