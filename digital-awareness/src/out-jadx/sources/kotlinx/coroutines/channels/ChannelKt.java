...
public final class ChannelKt {
    public static final <E> Channel<E> Channel(int capacity, BufferOverflow onBufferOverflow, Function1<? super E, Unit> function1) {
        switch (capacity) {
            ...
            case 0:
                return onBufferOverflow == BufferOverflow.SUSPEND ? new RendezvousChannel(function1) : new ArrayChannel(1, onBufferOverflow, function1);
            case Integer.MAX_VALUE:
                return new LinkedListChannel(function1);
            default:
                return (capacity == 1 && onBufferOverflow == BufferOverflow.DROP_OLDEST) ? new ConflatedChannel(function1) : new ArrayChannel(capacity, onBufferOverflow, function1);
        }
    }
