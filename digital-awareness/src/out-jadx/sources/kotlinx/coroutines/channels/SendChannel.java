...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1535trySendJP2dKIU = sendChannel.mo1535trySendJP2dKIU(e);
            if (ChannelResult.m1550isSuccessimpl(mo1535trySendJP2dKIU)) {
                return true;
            }
            Throwable m1544exceptionOrNullimpl = ChannelResult.m1544exceptionOrNullimpl(mo1535trySendJP2dKIU);
