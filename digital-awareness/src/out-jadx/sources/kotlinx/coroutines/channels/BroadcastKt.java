...
public final class BroadcastKt {
    public static final <E> BroadcastChannel<E> broadcast(CoroutineScope $this$broadcast, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> function1, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        LazyBroadcastCoroutine lazyBroadcastCoroutine = start.isLazy() ? new LazyBroadcastCoroutine(newCoroutineContext, BroadcastChannel, function2) : new BroadcastCoroutine(newCoroutineContext, BroadcastChannel, true);
        if (function1 != null) {
            lazyBroadcastCoroutine.invokeOnCompletion(function1);
        }
        lazyBroadcastCoroutine.start(start, lazyBroadcastCoroutine, function2);
