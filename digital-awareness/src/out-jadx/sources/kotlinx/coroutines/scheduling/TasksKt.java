...
public final class TasksKt {
    ...
    public static final int MAX_POOL_SIZE = SystemPropsKt.systemProp$default("kotlinx.coroutines.scheduler.max.pool.size", (int) CoroutineScheduler.MAX_SUPPORTED_POOL_SIZE, 0, (int) CoroutineScheduler.MAX_SUPPORTED_POOL_SIZE, 4, (Object) null);
