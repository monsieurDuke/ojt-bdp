...
public class LockFreeLinkedListNode {
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            if (onPrepare != LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                ...
                AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, (LockFreeLinkedListNode) affected, this, decide == AtomicKt.NO_DECISION ? getAtomicOp() : decide == null ? this.desc.updatedNext((LockFreeLinkedListNode) affected, this.next) : this.next);
                return null;
            }
            LockFreeLinkedListNode lockFreeLinkedListNode = this.next;
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, (LockFreeLinkedListNode) affected, this, lockFreeLinkedListNode.removed())) {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo1579remove()) {
                return lockFreeLinkedListNode;
            }
     ...
     */
    public String toString() {
        StringBuilder append = new StringBuilder().append(new PropertyReference0Impl(this) { // from class: kotlinx.coroutines.internal.LockFreeLinkedListNode$toString$1
            /* JADX WARN: Failed to parse debug info
            jadx.core.utils.exceptions.JadxRuntimeException: Failed to parse type string: null
            	at jadx.core.dex.instructions.args.ArgType.parse(ArgType.java:736)
            	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.getVarType(DebugInfoAttachVisitor.java:139)
