...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object $this$toState, Function1<? super Throwable, Unit> function1) {
        Throwable m47exceptionOrNullimpl = Result.m47exceptionOrNullimpl($this$toState);
        return m47exceptionOrNullimpl == null ? function1 != null ? new CompletedWithCancellation($this$toState, function1) : $this$toState : new CompletedExceptionally(m47exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(Object $this$toState, CancellableContinuation<?> cancellableContinuation) {
        ...
        return new CompletedExceptionally((DebugKt.getRECOVER_STACK_TRACES() && (cancellableContinuation instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(m47exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation) : m47exceptionOrNullimpl, false, 2, null);
    }
