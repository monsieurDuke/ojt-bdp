...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m44constructorimpl = Result.m44constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), objArr2 == true ? 1 : 0, 2, objArr == true ? 1 : 0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m50isFailureimpl(m44constructorimpl) ? null : m44constructorimpl);
    }
    ...
    public static final Handler asHandler(Looper $this$asHandler, boolean async) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            try {
                return (Handler) Handler.class.getDeclaredConstructor(Looper.class, Handler.Callback.class, Boolean.TYPE).newInstance($this$asHandler, null, true);
            } catch (NoSuchMethodException e) {
                return new Handler($this$asHandler);
            }
        }
        Object invoke = Handler.class.getDeclaredMethod("createAsync", Looper.class).invoke(null, $this$asHandler);
        if (invoke != null) {
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1580dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
