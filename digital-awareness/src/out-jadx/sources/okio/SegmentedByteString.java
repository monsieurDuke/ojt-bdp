...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteString digest$okio(String algorithm) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = getDirectory()[length + i2];
            int i4 = getDirectory()[i2];
            messageDigest.update(getSegments()[i2], i3, i4 - i);
            i = i4;
        }
    ...
    public ByteString hmac$okio(String algorithm, ByteString key) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                int i3 = getDirectory()[length + i2];
                int i4 = getDirectory()[i2];
                mac.update(getSegments()[i2], i3, i4 - i);
                i = i4;
            }
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        if (offset >= 0 && offset <= segmentedByteString.size() - byteCount) {
            int i = otherOffset;
            ...
            while (i3 < i2) {
                ...
                if (!other.rangeEquals(i, segmentedByteString.getSegments()[segment], (i3 - i4) + i6, min)) {
                    return false;
                }
                i += min;
                i3 += min;
    ...
    public boolean rangeEquals(int offset, byte[] other, int otherOffset, int byteCount) {
        ...
        while (i3 < i2) {
            ...
            int min = Math.min(i2, i4 + i5) - i3;
            if (!Util.arrayRangeEquals(getSegments()[segment], i6 + (i3 - i4), other, i, min)) {
                return false;
            }
            i += min;
            i3 += min;
    ...
    public byte[] toByteArray() {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            int i6 = i5 - i2;
            ArraysKt.copyInto(getSegments()[i3], bArr, i, i4, i4 + i6);
            i += i6;
            i2 = i5;
        }
        return bArr;
    ...
    public void write(OutputStream out) throws IOException {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = getDirectory()[length + i2];
            int i4 = getDirectory()[i2];
            out.write(getSegments()[i2], i3, i4 - i);
            i = i4;
        }
    }
