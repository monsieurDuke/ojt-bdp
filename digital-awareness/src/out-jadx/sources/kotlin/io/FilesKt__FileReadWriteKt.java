...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final void forEachBlock(File $this$forEachBlock, int blockSize, Function2<? super byte[], ? super Integer, Unit> action) {
        ...
        try {
            ...
            while (true) {
                int read = fileInputStream2.read(r0);
                if (read <= 0) {
                    Unit unit = Unit.INSTANCE;
        ...
        try {
            ...
            if (i2 > 0) {
                ...
                if (read2 != -1) {
                    ...
                    byte[] copyOf2 = Arrays.copyOf(bArr, length2);
                    Intrinsics.checkNotNullExpressionValue(copyOf2, "copyOf(this, newSize)");
                    bArr = ArraysKt.copyInto(buffer, copyOf2, bArr.length, 0, exposingBufferByteArrayOutputStream.size());
                }
            }
            CloseableKt.closeFinally(fileInputStream, null);
            return bArr;
