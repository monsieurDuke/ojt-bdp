...
class CharsKt__CharKt extends CharsKt__CharJVMKt {
    ...
    public static final char digitToChar(int $this$digitToChar, int radix) {
        ...
        return $this$digitToChar < 10 ? (char) ($this$digitToChar + 48) : (char) (((char) ($this$digitToChar + 65)) - '\n');
    }
    ...
    public static final String titlecase(char c) {
        String titlecaseImpl = _OneToManyTitlecaseMappingsKt.titlecaseImpl(c);
        Log5ECF72.a(titlecaseImpl);
        LogE84000.a(titlecaseImpl);
        Log229316.a(titlecaseImpl);
