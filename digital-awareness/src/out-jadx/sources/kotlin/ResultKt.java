...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable m47exceptionOrNullimpl = Result.m47exceptionOrNullimpl($this$fold);
        return m47exceptionOrNullimpl == null ? onSuccess.invoke($this$fold) : onFailure.invoke(m47exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return m47exceptionOrNullimpl == null ? obj : onFailure.invoke(m47exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> transform) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m44constructorimpl(transform.invoke($this$mapCatching));
        } catch (Throwable th) {
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        ...
        Throwable m47exceptionOrNullimpl = Result.m47exceptionOrNullimpl($this$onFailure);
        if (m47exceptionOrNullimpl != null) {
            action.invoke(m47exceptionOrNullimpl);
        }
    ...
    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable m47exceptionOrNullimpl = Result.m47exceptionOrNullimpl($this$recover);
        if (m47exceptionOrNullimpl == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m44constructorimpl(transform.invoke(m47exceptionOrNullimpl));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable m47exceptionOrNullimpl = Result.m47exceptionOrNullimpl($this$recoverCatching);
        if (m47exceptionOrNullimpl == null) {
