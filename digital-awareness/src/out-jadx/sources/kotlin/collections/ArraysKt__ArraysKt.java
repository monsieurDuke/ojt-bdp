        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr != objArr2) {
                ...
                if ((objArr instanceof Object[]) && (objArr2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m607contentEqualsFGO6Aew(((UShortArray) objArr).getStorage(), ((UShortArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UIntArray) && (objArr2 instanceof UIntArray)) {
                    if (!UArraysKt.m608contentEqualsKJPZfPQ(((UIntArray) objArr).getStorage(), ((UIntArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof ULongArray) && (objArr2 instanceof ULongArray)) {
                    if (!UArraysKt.m612contentEqualslec5QzE(((ULongArray) objArr).getStorage(), ((ULongArray) objArr2).getStorage())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr == 0) {
                ...
                String str = UArraysKt.m624contentToString2csIQuQ(uByteArray != null ? uByteArray.getStorage() : null);
                Log5ECF72.a(str);
                LogE84000.a(str);
                Log229316.a(str);
                sb.append(str);
                ...
                String str2 = UArraysKt.m628contentToStringd6D3K8(uShortArray != null ? uShortArray.getStorage() : null);
                Log5ECF72.a(str2);
                LogE84000.a(str2);
                Log229316.a(str2);
                sb.append(str2);
                ...
                String str3 = UArraysKt.m627contentToStringXUkPCBk(uIntArray != null ? uIntArray.getStorage() : null);
                Log5ECF72.a(str3);
                LogE84000.a(str3);
                Log229316.a(str3);
                sb.append(str3);
                ...
                String str4 = UArraysKt.m630contentToStringuLth9ew(uLongArray != null ? uLongArray.getStorage() : null);
                Log5ECF72.a(str4);
                LogE84000.a(str4);
                Log229316.a(str4);
                sb.append(str4);
