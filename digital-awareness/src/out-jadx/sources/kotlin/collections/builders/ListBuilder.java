...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    private final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        E[] eArr2 = this.array;
        ArraysKt.copyInto(eArr2, eArr2, rangeOffset + i2, rangeOffset + rangeLength, this.length);
        E[] eArr3 = this.array;
        int i4 = this.length;
    ...
    public String toString() {
        ...
        Log5ECF72.a(access$subarrayContentToString);
        LogE84000.a(access$subarrayContentToString);
        Log229316.a(access$subarrayContentToString);
