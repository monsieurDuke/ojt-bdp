...
public final class ListBuilderKt {
    ...
    public static final /* synthetic */ String access$subarrayContentToString(Object[] objArr, int i, int i2) {
        String subarrayContentToString = subarrayContentToString(objArr, i, i2);
        Log5ECF72.a(subarrayContentToString);
        LogE84000.a(subarrayContentToString);
        Log229316.a(subarrayContentToString);
    ...
    private static final <T> String subarrayContentToString(T[] tArr, int offset, int length) {
