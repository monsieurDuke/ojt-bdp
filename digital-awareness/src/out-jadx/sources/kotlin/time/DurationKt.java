...
public final class DurationKt {
    ...
    */
    ...
    private static final String substringWhile(String $this$substringWhile, int startIndex, Function1<? super Character, Boolean> function1) {
        int i = startIndex;
        while (i < $this$substringWhile.length() && function1.invoke(Character.valueOf($this$substringWhile.charAt(i))).booleanValue()) {
            i++;
        }
    ...
    public static final long toDuration(double $this$toDuration, DurationUnit unit) {
        ...
        if ((!Double.isNaN(convertDurationUnit)) != true) {
    ...
    public static final long toDuration(int $this$toDuration, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return unit.compareTo(DurationUnit.SECONDS) <= 0 ? durationOfNanos(DurationUnitKt.convertDurationUnitOverflow($this$toDuration, unit, DurationUnit.NANOSECONDS)) : toDuration($this$toDuration, unit);
    }
