    ...
    public long nextLong(long from, long until) {
        ...
        if (j3 > 0) {
            if (((-j3) & j3) == j3) {
                int i = (int) (j3 >>> 32);
                if (((int) j3) != 0) {
                    nextInt = 4294967295L & nextBits(RandomKt.fastLog2(r3));
                } else if (i == 1) {
                    nextInt = 4294967295L & nextInt();
                } else {
                    nextInt = (4294967295L & nextInt()) + (nextBits(RandomKt.fastLog2(i)) << 32);
                }
                j2 = nextInt;
            } else {
                do {
