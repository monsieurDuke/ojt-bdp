...
public class ReflectionFactory {
    ...
    public KType mutableCollectionType(KType type) {
        ...
        return new TypeReference(type.getClassifier(), type.getArguments(), typeReference.getPlatformTypeUpperBound(), typeReference.getFlags() | 2);
    }
    ...
    public KType nothingType(KType type) {
        TypeReference typeReference = (TypeReference) type;
        return new TypeReference(type.getClassifier(), type.getArguments(), typeReference.getPlatformTypeUpperBound(), typeReference.getFlags() | 4);
    }
