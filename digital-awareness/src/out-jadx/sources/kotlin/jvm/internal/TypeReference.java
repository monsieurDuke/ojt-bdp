...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        if (isEmpty) {
            ...
            joinToString$default = CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
                ...
                public final CharSequence invoke(KTypeProjection it) {
                    ...
                    Log5ECF72.a(asString);
                    LogE84000.a(asString);
                    Log229316.a(asString);
                    return asString;
                }
            }, 24, null);
        ...
        if (kType instanceof TypeReference) {
            ...
            if (!Intrinsics.areEqual(asString, str2)) {
                return Intrinsics.areEqual(asString, new StringBuilder().append(str2).append('?').toString()) ? str2 + '!' : '(' + str2 + ".." + asString + ')';
            }
        }
        return str2;
    }
