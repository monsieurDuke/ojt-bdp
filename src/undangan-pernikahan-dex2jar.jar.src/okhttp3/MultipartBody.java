  ...
  extends RequestBody
{
  ...
  public MultipartBody(ByteString paramByteString, MediaType paramMediaType, List<Part> paramList)
  {
    ...
    this.contentType = MediaType.Companion.get(paramMediaType + "; boundary=" + boundary());
    ...
    throws IOException
  {
    ...
    for (int i = 0; i < k; i++)
    {
      ...
      if (localObject2 != null)
      {
        ...
        for (int j = 0; j < m; j++) {
          paramBufferedSink.writeUtf8(((Headers)localObject2).name(j)).write(COLONSPACE).writeUtf8(((Headers)localObject2).value(j)).write(CRLF);
        }
      }
      ...
      localObject2 = CRLF;
      paramBufferedSink.write((byte[])localObject2);
      if (paramBoolean) {
        l1 += l2;
      } else {
  ...
  public static final class Builder
  {
    ...
    public final Builder addFormDataPart(String paramString1, String paramString2)
    {
      ...
      ((Builder)this).addPart(MultipartBody.Part.Companion.createFormData(paramString1, paramString2));
      return (Builder)this;
    }
    ...
    public final Builder addFormDataPart(String paramString1, String paramString2, RequestBody paramRequestBody)
    {
      ...
      ((Builder)this).addPart(MultipartBody.Part.Companion.createFormData(paramString1, paramString2, paramRequestBody));
      return (Builder)this;
    }
    ...
    {
      Intrinsics.checkNotNullParameter(paramRequestBody, "body");
      ((Builder)this).addPart(MultipartBody.Part.Companion.create(paramHeaders, paramRequestBody));
      return (Builder)this;
    }
    
    public final Builder addPart(MultipartBody.Part paramPart)
    {
      Intrinsics.checkNotNullParameter(paramPart, "part");
      ((Collection)((Builder)this).parts).add(paramPart);
      return (Builder)this;
    }
    ...
    {
      Intrinsics.checkNotNullParameter(paramRequestBody, "body");
      ((Builder)this).addPart(MultipartBody.Part.Companion.create(paramRequestBody));
      return (Builder)this;
    }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/MultipartBody.class
