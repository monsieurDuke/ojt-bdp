...
public final class Route
{
  ...
  {
    boolean bool;
    if (((paramObject instanceof Route)) && (Intrinsics.areEqual(((Route)paramObject).address, this.address)) && (Intrinsics.areEqual(((Route)paramObject).proxy, this.proxy)) && (Intrinsics.areEqual(((Route)paramObject).socketAddress, this.socketAddress))) {
      bool = true;
    } else {
      bool = false;
    }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/Route.class
