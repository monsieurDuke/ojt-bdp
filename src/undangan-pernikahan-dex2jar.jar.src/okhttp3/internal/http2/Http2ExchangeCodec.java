  ...
  implements ExchangeCodec
{
  ...
  public Sink createRequestBody(Request paramRequest, long paramLong)
  {
    ...
    Intrinsics.checkNotNull(paramRequest);
  ...
  {
    Http2Stream localHttp2Stream = this.stream;
    Intrinsics.checkNotNull(localHttp2Stream);
  ...
  public Source openResponseBodySource(Response paramResponse)
  {
    ...
    Intrinsics.checkNotNull(paramResponse);
  ...
  public Response.Builder readResponseHeaders(boolean paramBoolean)
  {
    ...
    localObject = Companion.readHttp2HeadersList((Headers)localObject, this.protocol);
    if ((paramBoolean) && (((Response.Builder)localObject).getCode$okhttp() == 100)) {
      localObject = null;
    }
  ...
  public static final class Companion
  {
    public final List<Header> http2HeadersList(Request paramRequest)
    {
      ...
      while (i < j)
      {
        ...
        Intrinsics.checkNotNullExpressionValue(paramRequest, "Locale.US");
        if (str != null)
        {
          paramRequest = str.toLowerCase(paramRequest);
          Intrinsics.checkNotNullExpressionValue(paramRequest, "(this as java.lang.String).toLowerCase(locale)");
    ...
    public final Response.Builder readHttp2HeadersList(Headers paramHeaders, Protocol paramProtocol)
    {
      ...
      while (i < j)
      {
        ...
        {
          localObject2 = StatusLine.Companion.parse("HTTP/1.1 " + str1);
        }
        else
        {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/internal/http2/Http2ExchangeCodec.class
