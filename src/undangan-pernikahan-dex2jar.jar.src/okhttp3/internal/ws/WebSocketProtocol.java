...
public final class WebSocketProtocol
{
  ...
  public final String acceptHeader(String paramString)
  {
    ...
    return ByteString.Companion.encodeUtf8(paramString + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11").sha1().base64();
  }
  ...
  public final String closeCodeExceptionMessage(int paramInt)
  {
    ...
    if ((paramInt >= 1000) && (paramInt < 5000))
    {
      if (((1004 <= paramInt) && (1006 >= paramInt)) || ((1015 <= paramInt) && (2999 >= paramInt))) {
        str = "Code " + paramInt + " is reserved and may not be used.";
      } else {
        str = null;
      }
    }
    else {
      str = "Code must be in range [1000,5000): " + paramInt;
    }
    return str;
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/internal/ws/WebSocketProtocol.class
