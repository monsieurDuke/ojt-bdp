  ...
  implements Closeable
{
  ...
  {
    paramString = header$default(this, paramString, null, 2, null);
  ...
  public static class Builder
  {
        ...
        if (i != 0)
        {
          ...
          if (i != 0)
          {
            ...
            if (i != 0)
            {
              ...
              if (i == 0) {
                throw ((Throwable)new IllegalArgumentException((paramString + ".priorResponse != null").toString()));
              }
            }
            else
            {
              throw ((Throwable)new IllegalArgumentException((paramString + ".cacheResponse != null").toString()));
            }
          }
          else
          {
            throw ((Throwable)new IllegalArgumentException((paramString + ".networkResponse != null").toString()));
          }
        }
        else
        {
          throw ((Throwable)new IllegalArgumentException((paramString + ".body != null").toString()));
        }
      }
    }
    ...
    public Builder addHeader(String paramString1, String paramString2)
    {
      ...
      ((Builder)this).headers.add(paramString1, paramString2);
      return (Builder)this;
    }
    
    public Builder body(ResponseBody paramResponseBody)
    {
      ((Builder)this).body = paramResponseBody;
      return (Builder)this;
    }
    ...
    public Response build()
    {
      ...
      if (i != 0)
      {
        ...
        if (localRequest != null)
        {
          ...
          if (localProtocol != null)
          {
            ...
            if (str != null) {
              return new Response(localRequest, localProtocol, str, j, this.handshake, this.headers.build(), this.body, this.networkResponse, this.cacheResponse, this.priorResponse, this.sentRequestAtMillis, this.receivedResponseAtMillis, this.exchange);
            }
      ...
      throw ((Throwable)new IllegalStateException(("code < 0: " + this.code).toString()));
    }
    ...
    {
      ((Builder)this).handshake = paramHandshake;
      return (Builder)this;
    }
    ...
    public Builder header(String paramString1, String paramString2)
    {
      Intrinsics.checkNotNullParameter(paramString1, "name");
      Intrinsics.checkNotNullParameter(paramString2, "value");
      ((Builder)this).headers.set(paramString1, paramString2);
      return (Builder)this;
    }
    ...
    public Builder headers(Headers paramHeaders)
    {
      ...
      ((Builder)this).headers = paramHeaders.newBuilder();
      return (Builder)this;
    }
    ...
    public Builder message(String paramString)
    {
      ...
      ((Builder)this).message = paramString;
      return (Builder)this;
    }
    ...
    public Builder protocol(Protocol paramProtocol)
    {
      ...
      ((Builder)this).protocol = paramProtocol;
      return (Builder)this;
    }
    
    public Builder receivedResponseAtMillis(long paramLong)
    {
      ((Builder)this).receivedResponseAtMillis = paramLong;
      return (Builder)this;
    }
    ...
    {
      Intrinsics.checkNotNullParameter(paramString, "name");
      ((Builder)this).headers.removeAll(paramString);
      return (Builder)this;
    }
    ...
    public Builder request(Request paramRequest)
    {
      ...
      ((Builder)this).request = paramRequest;
      return (Builder)this;
    }
    
    public Builder sentRequestAtMillis(long paramLong)
    {
      ((Builder)this).sentRequestAtMillis = paramLong;
      return (Builder)this;
    }
    ...
    {
      Intrinsics.checkNotNullParameter(paramBuilder, "<set-?>");
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okhttp3/Response.class
