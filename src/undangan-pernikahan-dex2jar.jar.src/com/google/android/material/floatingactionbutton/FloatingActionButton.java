  ...
  implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior
{
  ...
  public FloatingActionButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    Object localObject1 = ThemeEnforcement.obtainStyledAttributes((Context)localObject2, paramAttributeSet, R.styleable.FloatingActionButton, paramInt, j, new int[0]);
    this.backgroundTint = MaterialResources.getColorStateList((Context)localObject2, (TypedArray)localObject1, R.styleable.FloatingActionButton_backgroundTint);
    this.backgroundTintMode = ViewUtils.parseTintMode(((TypedArray)localObject1).getInt(R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
    this.rippleColor = MaterialResources.getColorStateList((Context)localObject2, (TypedArray)localObject1, R.styleable.FloatingActionButton_rippleColor);
    this.size = ((TypedArray)localObject1).getInt(R.styleable.FloatingActionButton_fabSize, -1);
    this.customSize = ((TypedArray)localObject1).getDimensionPixelSize(R.styleable.FloatingActionButton_fabCustomSize, 0);
    this.borderWidth = ((TypedArray)localObject1).getDimensionPixelSize(R.styleable.FloatingActionButton_borderWidth, 0);
    ...
    this.compatPadding = ((TypedArray)localObject1).getBoolean(R.styleable.FloatingActionButton_useCompatPadding, false);
    ...
    MotionSpec localMotionSpec = MotionSpec.createFromAttribute((Context)localObject2, (TypedArray)localObject1, R.styleable.FloatingActionButton_showMotionSpec);
    paramContext = MotionSpec.createFromAttribute((Context)localObject2, (TypedArray)localObject1, R.styleable.FloatingActionButton_hideMotionSpec);
    localObject2 = ShapeAppearanceModel.builder((Context)localObject2, paramAttributeSet, paramInt, j, ShapeAppearanceModel.PILL).build();
    ...
    localObject1 = new AppCompatImageHelper(this);
    this.imageHelper = ((AppCompatImageHelper)localObject1);
    ((AppCompatImageHelper)localObject1).loadFromAttributes(paramAttributeSet, paramInt);
    this.expandableWidgetHelper = new ExpandableWidgetHelper(this);
    getImpl().setShapeAppearance((ShapeAppearanceModel)localObject2);
  ...
  public void setMaxImageSize(int paramInt)
  {
    ...
    getImpl().setMaxImageSize(paramInt);
  }
    ...
    implements ShadowViewDelegate
  {
    ...
    public void setShadowPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
      ...
      localFloatingActionButton.setPadding(localFloatingActionButton.imagePadding + paramInt1, FloatingActionButton.this.imagePadding + paramInt2, FloatingActionButton.this.imagePadding + paramInt3, FloatingActionButton.this.imagePadding + paramInt4);
    }
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/com/google/android/material/floatingactionbutton/FloatingActionButton.class
