...
class FitModeEvaluators
{
  ...
  private static boolean shouldAutoFitToWidth(boolean paramBoolean, RectF paramRectF1, RectF paramRectF2)
  {
    ...
    float f3 = paramRectF2.height();
    float f1 = f3 * f5 / f4;
    f4 = f2 * f4 / f5;
    boolean bool = true;
    if (paramBoolean ? f1 >= f2 : f4 >= f3) {
      paramBoolean = bool;
    } else {
      paramBoolean = false;
    }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/com/google/android/material/transition/FitModeEvaluators.class
