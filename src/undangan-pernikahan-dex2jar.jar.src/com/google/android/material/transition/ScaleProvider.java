  ...
  implements VisibilityAnimatorProvider
{
  ...
  {
    final float f2 = paramView.getScaleX();
    final float f1 = paramView.getScaleY();
    ObjectAnimator localObjectAnimator = ObjectAnimator.ofPropertyValuesHolder(paramView, new PropertyValuesHolder[] { PropertyValuesHolder.ofFloat(View.SCALE_X, new float[] { f2 * paramFloat1, f2 * paramFloat2 }), PropertyValuesHolder.ofFloat(View.SCALE_Y, new float[] { f1 * paramFloat1, f1 * paramFloat2 }) });
    localObjectAnimator.addListener(new AnimatorListenerAdapter()
    {
      public void onAnimationEnd(Animator paramAnonymousAnimator)
      {
        ScaleProvider.this.setScaleX(f2);
        ScaleProvider.this.setScaleY(f1);
      }
    });
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/com/google/android/material/transition/ScaleProvider.class
