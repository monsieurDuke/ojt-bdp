  ...
  implements CardViewImpl
{
  ...
  public void initStatic()
  {
    RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper()
    {
      ...
      {
        float f3 = paramAnonymousFloat * 2.0F;
        float f2 = paramAnonymousRectF.width() - f3 - 1.0F;
        float f1 = paramAnonymousRectF.height();
        if (paramAnonymousFloat >= 1.0F)
        {
          ...
          paramAnonymousCanvas.drawArc(CardViewBaseImpl.this.mCornerRect, 180.0F, 90.0F, true, paramAnonymousPaint);
          paramAnonymousCanvas.translate(f1 - f3 - 1.0F, 0.0F);
          paramAnonymousCanvas.rotate(90.0F);
          paramAnonymousCanvas.drawArc(CardViewBaseImpl.this.mCornerRect, 180.0F, 90.0F, true, paramAnonymousPaint);
          paramAnonymousCanvas.translate(f2, 0.0F);
          paramAnonymousCanvas.rotate(90.0F);
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/cardview/widget/CardViewBaseImpl.class
