  ...
  implements Runnable
{
  ...
  private void iterativelyCancelWorkAndDependents(WorkDatabase paramWorkDatabase, String paramString)
  {
    ...
    DependencyDao localDependencyDao = paramWorkDatabase.dependencyDao();
    ...
    while (!paramWorkDatabase.isEmpty())
    {
      ...
      paramWorkDatabase.addAll(localDependencyDao.getDependentWorkIds(paramString));
    }
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/impl/utils/CancelWorkRunnable.class
