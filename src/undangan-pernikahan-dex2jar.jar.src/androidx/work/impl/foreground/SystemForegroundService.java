  ...
  implements SystemForegroundDispatcher.Callback
{
  ...
  static
  {
    String str = Logger.tagWithPrefix("SystemFgService");
    Log5ECF72.a(str);
    LogE84000.a(str);
    Log229316.a(str);
    TAG = str;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/work/impl/foreground/SystemForegroundService.class
