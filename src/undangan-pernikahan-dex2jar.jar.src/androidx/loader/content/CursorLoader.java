  ...
  extends AsyncTaskLoader<Cursor>
{
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    paramFileDescriptor = Arrays.toString(this.mProjection);
    Log5ECF72.a(paramFileDescriptor);
    LogE84000.a(paramFileDescriptor);
    Log229316.a(paramFileDescriptor);
    ...
    paramFileDescriptor = Arrays.toString(this.mSelectionArgs);
    Log5ECF72.a(paramFileDescriptor);
    LogE84000.a(paramFileDescriptor);
    Log229316.a(paramFileDescriptor);
    paramPrintWriter.println(paramFileDescriptor);
  ...
  public Cursor loadInBackground()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 148	androidx/loader/content/CursorLoader:isLoadInBackgroundCanceled	()Z
    //   6: ifne +119 -> 125
    //   9: new 51	androidx/core/os/CancellationSignal
    //   12: astore_1
    //   13: aload_1
    //   14: invokespecial 150	androidx/core/os/CancellationSignal:<init>	()V
    //   17: aload_0
    //   18: aload_1
    ...
    //   23: monitorexit
    //   24: aload_0
    //   25: invokevirtual 154	androidx/loader/content/CursorLoader:getContext	()Landroid/content/Context;
    //   28: invokevirtual 160	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   31: aload_0
    ...
    //   55: invokestatic 166	androidx/core/content/ContentResolverCompat:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroidx/core/os/CancellationSignal;)Landroid/database/Cursor;
    //   58: astore_2
    //   59: aload_2
    //   60: ifnull +32 -> 92
    //   63: aload_2
    //   64: invokeinterface 170 1 0
    //   69: pop
    //   70: aload_2
    //   71: aload_0
    //   72: getfield 31	androidx/loader/content/CursorLoader:mObserver	Landroidx/loader/content/Loader$ForceLoadContentObserver;
    //   75: invokeinterface 174 2 0
    //   80: goto +12 -> 92
    //   83: astore_1
    //   84: aload_2
    ...
    //   123: aload_1
    //   124: athrow
    //   125: new 176	androidx/core/os/OperationCanceledException
    //   128: astore_1
    //   129: aload_1
    //   130: invokespecial 177	androidx/core/os/OperationCanceledException:<init>	()V
    //   133: aload_1
    //   134: athrow
    //   135: astore_1
    //   136: aload_0
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/loader/content/CursorLoader.class
