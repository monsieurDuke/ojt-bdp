  ...
  extends ViewGroup
{
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    i8 = Math.max(Math.max(i9 + i7, i8 + j), i10 + i5);
    ...
    i = Math.max(n - m - k, i3 + this.mScaledTextSpacing);
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/viewpager/widget/PagerTitleStrip.class
