...
public class WindowInsetsCompat
{
  ...
  {
    int k = Math.max(0, paramInsets.left - paramInt1);
    int i = Math.max(0, paramInsets.top - paramInt2);
    int m = Math.max(0, paramInsets.right - paramInt3);
    int j = Math.max(0, paramInsets.bottom - paramInt4);
    if ((k == paramInt1) && (i == paramInt2) && (m == paramInt3) && (j == paramInt4)) {
      return paramInsets;
    }
    return Insets.of(k, i, m, j);
  }
  ...
  static class Api21ReflectionHolder
  {
    ...
    static
    {
      try
      {
        ...
        sViewAttachInfoField = localField;
        localField.setAccessible(true);
        Class localClass = Class.forName("android.view.View$AttachInfo");
        localField = localClass.getDeclaredField("mStableInsets");
        sStableInsets = localField;
        localField.setAccessible(true);
        localField = localClass.getDeclaredField("mContentInsets");
        sContentInsets = localField;
        localField.setAccessible(true);
        sReflectionSucceeded = true;
      }
      catch (ReflectiveOperationException localReflectiveOperationException)
      {
        Log.w("WindowInsetsCompat", "Failed to get visible insets from AttachInfo " + localReflectiveOperationException.getMessage(), localReflectiveOperationException);
      }
    }
    ...
    public static WindowInsetsCompat getRootWindowInsets(View paramView)
    {
      if ((sReflectionSucceeded) && (paramView.isAttachedToWindow()))
      {
        ...
        {
          Log.w("WindowInsetsCompat", "Failed to get insets from AttachInfo. " + paramView.getMessage(), paramView);
        }
        return null;
      }
      return null;
    ...
    extends WindowInsetsCompat.Impl
  {
    ...
    private Insets getVisibleInsets(View paramView)
    {
      if (Build.VERSION.SDK_INT < 30)
      {
        ...
        Object localObject2 = sGetViewRootImplMethod;
        Object localObject1 = null;
        if ((localObject2 != null) && (sAttachInfoClass != null) && (sVisibleInsetsField != null)) {
          try
          {
            paramView = ((Method)localObject2).invoke(paramView, new Object[0]);
            if (paramView == null)
            {
            ...
            localObject2 = (Rect)sVisibleInsetsField.get(paramView);
            paramView = (View)localObject1;
            if (localObject2 != null) {
              paramView = Insets.of((Rect)localObject2);
            }
            return paramView;
          }
          catch (ReflectiveOperationException paramView)
          {
            Log.e("WindowInsetsCompat", "Failed to get visible insets. (Reflection error). " + paramView.getMessage(), paramView);
            return null;
          }
        }
        return null;
    ...
    private static void loadReflectionField()
    {
      ...
      {
        Log.e("WindowInsetsCompat", "Failed to get visible insets. (Reflection error). " + localReflectiveOperationException.getMessage(), localReflectiveOperationException);
      }
    ...
    protected Insets getInsetsForType(int paramInt, boolean paramBoolean)
    {
      ...
      default: 
        return Insets.NONE;
      case 128: 
        localObject = this.mRootWindowInsets;
        if (localObject != null) {
          localObject = ((WindowInsetsCompat)localObject).getDisplayCutout();
        } else {
          localObject = getDisplayCutout();
        }
        if (localObject != null) {
          return Insets.of(((DisplayCutoutCompat)localObject).getSafeInsetLeft(), ((DisplayCutoutCompat)localObject).getSafeInsetTop(), ((DisplayCutoutCompat)localObject).getSafeInsetRight(), ((DisplayCutoutCompat)localObject).getSafeInsetBottom());
        }
        return Insets.NONE;
      case 64: 
      ...
      case 8: 
        localObject = this.mOverriddenInsets;
        if (localObject != null) {
          localObject = localObject[WindowInsetsCompat.Type.indexOf(8)];
        } else {
        ...
        localObject = getRootStableInsets();
        if (localInsets.bottom > ((Insets)localObject).bottom) {
          return Insets.of(0, 0, 0, localInsets.bottom);
        }
        localInsets = this.mRootViewVisibleInsets;
        if ((localInsets != null) && (!localInsets.equals(Insets.NONE)) && (this.mRootViewVisibleInsets.bottom > ((Insets)localObject).bottom)) {
      ...
      case 2: 
        if (paramBoolean)
        {
          ...
          return Insets.of(Math.max(localInsets.left, ((Insets)localObject).left), 0, Math.max(localInsets.right, ((Insets)localObject).right), Math.max(localInsets.bottom, ((Insets)localObject).bottom));
        }
        localInsets = getSystemWindowInsets();
        WindowInsetsCompat localWindowInsetsCompat = this.mRootWindowInsets;
        if (localWindowInsetsCompat != null) {
          localObject = localWindowInsetsCompat.getStableInsets();
        }
        int i = localInsets.bottom;
        paramInt = i;
        if (localObject != null) {
          paramInt = Math.min(i, ((Insets)localObject).bottom);
        }
    ...
    protected boolean isTypeVisible(int paramInt)
    {
      ...
      return true ^ getInsetsForType(paramInt, false).equals(Insets.NONE);
    }
  ...
  public static final class Type
  {
    ...
    static int indexOf(int paramInt)
    {
      ...
      {
      default: 
        throw new IllegalArgumentException("type needs to be >= FIRST and <= LAST, type=" + paramInt);
      case 256: 
        return 8;
      case 128: 
        return 7;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/view/WindowInsetsCompat.class
