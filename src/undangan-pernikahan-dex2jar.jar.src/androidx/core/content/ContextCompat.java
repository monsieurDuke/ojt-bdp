...
public class ContextCompat
{
  ...
  public static String getAttributionTag(Context paramContext)
  {
    ...
    {
      paramContext = Api30Impl.getAttributionTag(paramContext);
  ...
  public static String getSystemServiceName(Context paramContext, Class<?> paramClass)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      paramContext = Api23Impl.getSystemServiceName(paramContext, paramClass);
      Log5ECF72.a(paramContext);
      LogE84000.a(paramContext);
      Log229316.a(paramContext);
      return paramContext;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/content/ContextCompat.class
