  ...
  implements View.OnTouchListener
{
  ...
  private static class ClampedScroller
  {
    ...
    private float getValueAt(long paramLong)
    {
      ...
      long l1 = this.mStopTime;
      if ((l1 >= 0L) && (paramLong >= l1))
      {
        float f = this.mStopValue;
        return 1.0F - f + f * AutoScrollHelper.constrain((float)(paramLong - l1) / this.mEffectiveRampDown, 0.0F, 1.0F);
      }
      return AutoScrollHelper.constrain((float)(paramLong - l2) / this.mRampUpDuration, 0.0F, 1.0F) * 0.5F;
    }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/widget/AutoScrollHelper.class
