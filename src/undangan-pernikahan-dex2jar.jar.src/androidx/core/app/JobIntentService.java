  ...
  extends Service
{
    ...
    extends JobIntentService.WorkEnqueuer
  {
    ...
    CompatWorkEnqueuer(Context paramContext, ComponentName paramComponentName)
    {
      ...
      PowerManager.WakeLock localWakeLock = paramContext.newWakeLock(1, paramComponentName.getClassName() + ":launch");
      this.mLaunchWakeLock = localWakeLock;
      localWakeLock.setReferenceCounted(false);
      paramContext = paramContext.newWakeLock(1, paramComponentName.getClassName() + ":run");
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/app/JobIntentService.class
