  ...
  implements NotificationBuilderWithBuilderAccessor
{
  ...
  NotificationCompatBuilder(NotificationCompat.Builder paramBuilder)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (paramBuilder.mInvisibleActions.size() > 0)
      {
        ...
        for (int i = 0; i < paramBuilder.mInvisibleActions.size(); i++)
        {
          ...
          LogE84000.a(str);
          Log229316.a(str);
          localBundle.putBundle(str, NotificationCompatJellybean.getBundleForAction((NotificationCompat.Action)paramBuilder.mInvisibleActions.get(i)));
        }
    ...
    if (Build.VERSION.SDK_INT >= 28)
    {
      localObject2 = paramBuilder.mPersonList.iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject1 = (Person)((Iterator)localObject2).next();
        this.mBuilder.addPerson(((Person)localObject1).toAndroidPerson());
      }
    }
  ...
  private void addAction(NotificationCompat.Action paramAction)
  {
    if (Build.VERSION.SDK_INT >= 20)
    {
      ...
      if (Build.VERSION.SDK_INT >= 31) {
        ((Notification.Action.Builder)localObject1).setAuthenticationRequired(paramAction.isAuthenticationRequired());
      }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/app/NotificationCompatBuilder.class
