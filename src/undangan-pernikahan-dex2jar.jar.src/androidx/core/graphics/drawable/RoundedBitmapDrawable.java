  ...
  void updateDstRect()
  {
    if (this.mApplyGravity)
    {
      if (this.mIsCircular)
      {
        ...
        int k = Math.min(this.mDstRect.width(), this.mDstRect.height());
        int j = Math.max(0, (this.mDstRect.width() - k) / 2);
        i = Math.max(0, (this.mDstRect.height() - k) / 2);
        this.mDstRect.inset(j, i);
        this.mCornerRadius = (k * 0.5F);
      }
      else
      {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/core/graphics/drawable/RoundedBitmapDrawable.class
