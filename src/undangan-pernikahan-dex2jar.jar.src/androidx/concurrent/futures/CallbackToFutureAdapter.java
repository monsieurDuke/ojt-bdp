  ...
  public static final class Completer<T>
  {
    ...
    protected void finalize()
    {
      ...
      if ((localObject != null) && (!((CallbackToFutureAdapter.SafeFuture)localObject).isDone())) {
        ((CallbackToFutureAdapter.SafeFuture)localObject).setException(new CallbackToFutureAdapter.FutureGarbageCollectedException("The completer object was garbage collected - this future would otherwise never complete. The tag was: " + this.tag));
      }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/concurrent/futures/CallbackToFutureAdapter.class
