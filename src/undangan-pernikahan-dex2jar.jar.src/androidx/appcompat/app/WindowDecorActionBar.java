  ...
  implements ActionBarOverlayLayout.ActionBarVisibilityCallback
{
  ...
  private void init(View paramView)
  {
    ...
    if ((localObject != null) && (this.mContextView != null) && (paramView != null))
    {
      this.mContext = ((DecorToolbar)localObject).getContext();
  ...
  public void removeTabAt(int paramInt)
  {
    ...
    localObject = (TabImpl)this.mTabs.remove(paramInt);
    if (localObject != null) {
    ...
    if (i == paramInt)
    {
      if (this.mTabs.isEmpty()) {
        ...
        localObject = (ActionBar.Tab)this.mTabs.get(Math.max(0, paramInt - 1));
      }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/app/WindowDecorActionBar.class
