  ...
  private boolean tryShow()
  {
    ...
    if (!this.mWasDismissed)
    {
      ...
      if (localObject1 != null)
      {
        ...
        {
          localObject1 = (FrameLayout)LayoutInflater.from(this.mContext).inflate(R.layout.abc_popup_menu_header_item_layout, localListView, false);
          localObject2 = (TextView)((FrameLayout)localObject1).findViewById(16908310);
          if (localObject2 != null) {
            ((TextView)localObject2).setText(this.mMenu.getHeaderTitle());
          }
          ((FrameLayout)localObject1).setEnabled(false);
          localListView.addHeaderView((View)localObject1, null, false);
        }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/view/menu/StandardMenuPopup.class
