...
public class TintTypedArray
{
  ...
  public int getType(int paramInt)
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return Api21Impl.getType(this.mWrapped, paramInt);
    }
    if (this.mTypedValue == null) {
      this.mTypedValue = new TypedValue();
    }
  ...
  {
    static int getChangingConfigurations(TypedArray paramTypedArray)
    {
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/widget/TintTypedArray.class
