      ...
      case 2: 
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject2 == localObject1) {
            ((Toolbar)localObject1).removeView(this.mTabView);
          }
        }
        break;
      case 1: 
        ...
        if (localObject1 != null)
        {
          localObject1 = ((Spinner)localObject1).getParent();
          localObject2 = this.mToolbar;
          if (localObject1 == localObject2) {
            ((Toolbar)localObject2).removeView(this.mSpinner);
          }
        }
        break;
      }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/widget/ToolbarWidgetWrapper.class
