  ...
  implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView
{
  ...
  void initEmojiKeyListener(AppCompatEmojiEditTextHelper paramAppCompatEmojiEditTextHelper)
  {
    ...
    if (paramAppCompatEmojiEditTextHelper.isEmojiCapableKeyListener(localKeyListener))
    {
      ...
      boolean bool3 = super.isClickable();
      boolean bool2 = super.isLongClickable();
      ...
      super.setClickable(bool3);
      super.setLongClickable(bool2);
    }
  }
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/appcompat/widget/AppCompatAutoCompleteTextView.class
