  ...
  implements TypeEvaluator
{
  ...
  public Object evaluate(float paramFloat, Object paramObject1, Object paramObject2)
  {
    ...
    return Integer.valueOf(Math.round(((f1 - f2) * paramFloat + f2) * 255.0F) << 24 | Math.round(f4 * 255.0F) << 16 | Math.round(f5 * 255.0F) << 8 | Math.round(f3 * 255.0F));
  }
}


/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/vectordrawable/graphics/drawable/ArgbEvaluator.class
