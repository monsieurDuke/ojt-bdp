  ...
  extends VectorDrawableCommon
{
  ...
  public float getPixelSize()
  {
    ...
    if ((localVectorDrawableCompatState != null) && (localVectorDrawableCompatState.mVPathRenderer != null) && (this.mVectorState.mVPathRenderer.mBaseWidth != 0.0F) && (this.mVectorState.mVPathRenderer.mBaseHeight != 0.0F) && (this.mVectorState.mVPathRenderer.mViewportHeight != 0.0F) && (this.mVectorState.mVPathRenderer.mViewportWidth != 0.0F))
    {
      ...
      float f3 = this.mVectorState.mVPathRenderer.mViewportHeight;
    ...
    extends VectorDrawableCompat.VObject
  {
    ...
    public VGroup(VGroup paramVGroup, ArrayMap<String, Object> paramArrayMap)
    {
      ...
      this.mLocalMatrix = ((Matrix)localObject);
      this.mGroupName = null;
      ...
      ((Matrix)localObject).set(paramVGroup.mLocalMatrix);
  ...
  private static class VPathRenderer
  {
    ...
    {
      float f3 = paramInt1 / this.mViewportWidth;
      ...
      else
      {
        ...
        float f7 = paramVPath.mTrimPathStart;
        float f6 = paramVPath.mTrimPathOffset;
        ...
        if (paramVPath.mFillColor.willDraw())
        {
          ...
          if (this.mFillPaint == null)
          {
            ...
            this.mFillPaint = ((Paint)localObject);
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/androidx/vectordrawable/graphics/drawable/VectorDrawableCompat.class
