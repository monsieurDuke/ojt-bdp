  ...
  implements Sink
{
  ...
  {
    paramSink = new RealBufferedSink(paramSink);
    this.sink = paramSink;
    Deflater localDeflater = new Deflater(-1, true);
    this.deflater = localDeflater;
    this.deflaterSink = new DeflaterSink((BufferedSink)paramSink, localDeflater);
    this.crc = new CRC32();
    ...
    throws IOException
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 160	okio/GzipSink:closed	Z
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: aconst_null
    //   9: checkcast 162	java/lang/Throwable
    //   12: astore_2
    //   13: aload_0
    //   14: getfield 78	okio/GzipSink:deflaterSink	Lokio/DeflaterSink;
    //   17: invokevirtual 165	okio/DeflaterSink:finishDeflate$okio	()V
    //   20: aload_0
    //   21: invokespecial 167	okio/GzipSink:writeFooter	()V
    //   24: goto +4 -> 28
    //   27: astore_2
    //   28: aload_0
    //   29: getfield 69	okio/GzipSink:deflater	Ljava/util/zip/Deflater;
    //   32: invokevirtual 170	java/util/zip/Deflater:end	()V
    //   35: aload_2
    //   36: astore_1
    //   37: goto +12 -> 49
    //   40: astore_3
    ...
    //   53: invokevirtual 172	okio/RealBufferedSink:close	()V
    //   56: aload_1
    //   57: astore_2
    //   58: goto +12 -> 70
    //   61: astore_3
    ...
    //   70: aload_0
    //   71: iconst_1
    //   72: putfield 160	okio/GzipSink:closed	Z
    //   75: aload_2
    //   76: ifnonnull +4 -> 80
    //   79: return
    //   80: aload_2
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okio/GzipSink.class
