  ...
  extends ForwardingSink
{
  ...
  public HashingSink(Sink paramSink, ByteString paramByteString, String paramString)
  {
    ...
    try
    {
      ...
      paramSink.init((Key)localSecretKeySpec);
      paramByteString = Unit.INSTANCE;
      this.mac = paramSink;
      paramSink = (MessageDigest)null;
  ...
  public final ByteString hash()
  {
    ...
    Intrinsics.checkNotNullExpressionValue(localObject, "result");
    ...
    throws IOException
  {
    ...
    while (l < paramLong)
    {
      ...
      if (localObject != null)
      {
        ((MessageDigest)localObject).update(localSegment.data, localSegment.pos, i);
      }
      else
      {
        localObject = this.mac;
        Intrinsics.checkNotNull(localObject);
        ((Mac)localObject).update(localSegment.data, localSegment.pos, i);
      }
      l += i;
...
/* Location:              /home/icat/Documents/digital-awareness/src/undangan-pernikahan-dex2jar.jar!/okio/HashingSink.class
